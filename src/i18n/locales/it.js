...
export default {
  ...
  footer: {
    ...
    madeFor: 'Pensato per le famiglie su iOS e Android.',
  },

  legalNote:
    'Questa pagina è disponibile solo in inglese e il testo inglese è la versione che fa fede. Scrivi a [kidgate.support@gmail.com](mailto:kidgate.support@gmail.com) se ti serve aiuto per capirne una parte.',
  ...
  home: {
    heroBadge: 'Parental control, fatto bene',
    ...
    trust3Text: 'Controlli nativi del tempo di schermo su entrambe le piattaforme',
    ...
    feature3Title: 'Filtro web',
    feature3Text:
      'Blocca i siti per adulti e di gioco d’azzardo sul dispositivo del bambino e abbinalo al blocco app per una copertura più solida.',
    feature4Title: 'Posizione in tempo reale e luoghi',
    feature4Text:
      'Vedi l’ultima posizione di tuo figlio, consulta lo storico e ricevi un avviso quando arriva o lascia un luogo salvato.',
    feature5Title: 'Check-in e SOS',
    feature5Text:
      'Chiedi a tuo figlio di confermare che sta bene e ricevi un SOS immediato con posizione e foto in caso di emergenza.',
    feature6Title: 'Avvisi di protezione',
    feature6Text:
      'Scopri nell’istante in cui un permesso importante viene disattivato, così la protezione non svanisce in silenzio.',
    ...
    setupSub:
      'Non servono competenze tecniche — l’app ti guida passo dopo passo.',
    ...
    faq1A:
      'Sì. La prova parte quando colleghi i primi dispositivi genitore e figlio e include tutte le funzioni Premium.',
    ...
    ctaSub: 'Prova gratuita con accesso completo. Nessuna carta di credito per iniziare.',
  ...
  perm: {
    ...
    camera: 'Fotocamera',
    backgroundAppRefresh: 'Aggiornamento app in background',
    overlay: 'Mostra sopra altre app',
    batteryOptimization: 'Batteria senza restrizioni',
    exactAlarm: 'Sveglie precise',
  ...
  dash: {
    ...
    attnBatteryLowMeta: 'Gli aggiornamenti di posizione possono fermarsi se il telefono si spegne',
    ...
    rowAppBlockingDesc:
      '{{apps}} app · {{categories}} categorie selezionate sul dispositivo del bambino',
