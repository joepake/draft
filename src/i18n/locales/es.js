...
export default {
  meta: {
    ...
    description:
      'KidGate ayuda a los padres a gestionar el tiempo de pantalla, bloquear apps, filtrar la web y mantener el contacto, sin quitarle libertad al niño.',
  },
  ...
  nav: {
    ...
    privacy: 'Privacidad',
    terms: 'Términos',
    signIn: 'Acceso para padres',
  },

  footer: {
    blurb:
      'Control parental que ayuda a las familias a ponerse de acuerdo sobre el tiempo de pantalla en vez de discutir por él.',
    product: 'Producto',
    ...
    madeFor: 'Hecho para familias en iOS y Android.',
  },

  legalNote:
    'Esta página solo está disponible en inglés, y el texto en inglés es la versión que se aplica. Escribe a [kidgate.support@gmail.com](mailto:kidgate.support@gmail.com) si necesitas ayuda para entender alguna parte.',
  ...
  home: {
    heroBadge: 'Control parental, bien hecho',
    heroTitle: 'Protege a tus hijos',
    heroTitleAccent: 'sin quitarles su libertad.',
    heroLede:
      'KidGate da a los padres un control claro y tranquilo sobre el tiempo de pantalla, las apps y la seguridad, mientras los hijos conservan un móvil que sigue sintiéndose suyo.',
    heroCheck1: 'Tiempo de pantalla',
    ...
    trust3Title: 'iOS y Android',
    trust3Text: 'Controles nativos de tiempo de pantalla en ambas plataformas',
    ...
    feature1Title: 'Tiempo de pantalla y límites diarios',
    feature1Text:
    ...
    feature3Title: 'Filtrado web',
    feature3Text:
      'Rechaza sitios para adultos y de apuestas en el dispositivo del niño, y combínalo con el bloqueo de apps para una cobertura más fuerte.',
    feature4Title: 'Ubicación en vivo y lugares',
    feature4Text:
      'Consulta la última ubicación de tu hijo, revisa el historial y recibe un aviso cuando llega o sale de un lugar guardado.',
    feature5Title: 'Registro y SOS',
    feature5Text:
      'Pide a tu hijo que confirme que está bien y recibe un SOS inmediato con ubicación y foto en una emergencia.',
    feature6Title: 'Alertas de protección',
    feature6Text:
      'Entérate en el momento en que se desactiva un permiso importante, para que la protección no se apague en silencio.',

    showcaseEyebrow: 'Panel para padres',
    showcaseTitle: 'Toda la familia en una pantalla',
    showcaseSub:
      'Tiempo de pantalla, intentos bloqueados, ubicación y todo lo que necesita tu atención: en tu móvil o en cualquier navegador.',
    showcaseTile1: 'Tiempo de pantalla hoy',
    ...
    setupSub:
      'No hacen falta conocimientos técnicos: la app te guía en cada paso.',
    ...
    why1Text:
      'Una sola suscripción cubre todos los dispositivos de padres e hijos. Solo paga el titular de la familia.',
    ...
    faq1A:
      'Sí. La prueba empieza cuando se conectan tus primeros dispositivos de padre e hijo, e incluye todas las funciones Premium.',
    ...
    ctaSub: 'Prueba gratuita con acceso completo. No hace falta tarjeta para empezar.',
  ...
  viz: {
    ...
    none: '—',
    byDay: 'Tiempo de pantalla por día',
    limit: 'Límite {{value}}',
  ...
  dash: {
    ...
    tileScreenToday: 'Tiempo de pantalla hoy',
    ...
    cardScreenTime: 'Tiempo de pantalla',
    cardScreenTimeSub: 'Últimos 14 días, frente al límite diario',
    cardRecent: 'Actividad reciente',
    cardRecentSub: 'Lo más nuevo primero',
    cardRecentEmpty:
      'Todavía no hay registros. Los bloqueos, apps bloqueadas, avisos de lugares y sincronizaciones de tiempo de pantalla de este dispositivo aparecerán aquí.',
    ...
    attnPermissionOff: '{{permission}} está desactivado',
    attnPermissionOffMeta:
      'La protección es más débil hasta que se restaure en el dispositivo del niño',
    ...
    attnBatteryLowMeta: 'Las actualizaciones de ubicación pueden pararse si el móvil se apaga',
    attnReview: 'Revisar',
    attnResend: 'Reenviar',
    ...
    trendTitle: 'Tendencia del tiempo de pantalla',
  ...
  support: {
    ...
    contactEmail:
      '**Correo:** [kidgate.support@gmail.com](mailto:kidgate.support@gmail.com)',
