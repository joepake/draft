...
export default {
  ...
  legalNote:
    'هذه الصفحة متاحة بالإنجليزية فقط، والنص الإنجليزي هو النسخة المعتمدة. راسلنا على [kidgate.support@gmail.com](mailto:kidgate.support@gmail.com) إذا احتجت مساعدة في فهم أي جزء منها.',
  ...
  home: {
    ...
    feature3Title: 'تصفية الويب',
    feature3Text:
      'ارفض مواقع البالغين والمقامرة على جهاز الطفل، واجمعها مع حظر التطبيقات لحماية أقوى.',
    feature4Title: 'الموقع المباشر والأماكن',
    feature4Text:
      'اطّلع على آخر موقع لطفلك، وراجع السجل، واعرف حين يصل إلى مكان محفوظ أو يغادره.',
    feature5Title: 'الاطمئنان وSOS',
    feature5Text:
      'اطلب من طفلك تأكيد أنه بخير، واستقبل نداء SOS فوريًا مع الموقع وصورة عند الطوارئ.',
    feature6Title: 'تنبيهات الحماية',
    feature6Text:
      'اعرف في اللحظة التي يُطفأ فيها إذن مهم، حتى لا تتلاشى الحماية بصمت.',
  ...
  perm: {
    ...
    batteryOptimization: 'بطارية بلا قيود',
  ...
  dash: {
    ...
    rowAppBlockingDesc:
      '{{apps}} تطبيق · {{categories}} فئة محددة على جهاز الطفل',
  ...
  support: {
    ...
    contactEmail:
      '**البريد الإلكتروني:** [kidgate.support@gmail.com](mailto:kidgate.support@gmail.com)',
