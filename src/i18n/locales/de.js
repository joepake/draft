...
export default {
  ...
  footer: {
    ...
    madeFor: 'Gemacht für Familien auf iOS und Android.',
  },
  ...
  home: {
    ...
    trust3Title: 'iOS und Android',
    trust3Text: 'Native Bildschirmzeit-Steuerung auf beiden Plattformen',
    ...
    faq1A:
      'Ja. Die Testphase startet, sobald dein erstes Eltern- und Kindergerät verbunden sind, und enthält alle Premium-Funktionen.',
    ...
    ctaSub: 'Kostenlose Testphase mit vollem Zugriff. Zum Start keine Kreditkarte nötig.',
  ...
  authError: {
    ...
    tooManyRequests: 'Zu viele Versuche. Warte ein paar Minuten und versuche es erneut.',
  ...
  perm: {
    ...
    batteryOptimization: 'Uneingeschränkter Akku',
    exactAlarm: 'Exakte Alarme',
  ...
  dash: {
    ...
    rowAppBlockingDesc:
      '{{apps}} Apps · {{categories}} Kategorien auf dem Kindergerät ausgewählt',
