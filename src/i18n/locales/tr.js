...
export default {
  ...
  footer: {
    ...
    madeFor: 'iOS ve Android’deki aileler için yapıldı.',
  },
  ...
  home: {
    heroBadge: 'Ebeveyn denetimi, doğru biçimde',
    ...
    trust3Title: 'iOS ve Android',
    trust3Text: 'Her iki platformda da yerel ekran süresi denetimleri',
    ...
    setupSub:
      'Teknik bilgi gerekmez — uygulama her adımda size yol gösterir.',
    ...
    faq1A:
      'Evet. Deneme, ilk ebeveyn ve çocuk cihazlarınız bağlandığında başlar ve tüm Premium özellikleri içerir.',
  ...
  authError: {
    ...
    operationNotAllowed:
      'Bu giriş yöntemi bu proje için henüz etkinleştirilmedi.',
    unauthorizedDomain:
  ...
  perm: {
    ...
    camera: 'Kamera',
    backgroundAppRefresh: 'Arka planda uygulama yenileme',
    overlay: 'Diğer uygulamaların üzerinde göster',
    batteryOptimization: 'Kısıtlamasız pil',
  ...
  dash: {
    ...
    attnPermissionOffMeta:
      'Çocuk cihazında geri açılana kadar koruma daha zayıf kalır',
