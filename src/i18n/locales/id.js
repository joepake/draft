...
export default {
  ...
  nav: {
    ...
    privacy: 'Privasi',
    terms: 'Ketentuan',
    signIn: 'Masuk sebagai orang tua',
  },
  ...
  footer: {
    ...
    madeFor: 'Dibuat untuk keluarga di iOS dan Android.',
  },
  ...
  home: {
    heroBadge: 'Kontrol orang tua yang dilakukan dengan benar',
    ...
    trust3Title: 'iOS dan Android',
    trust3Text: 'Kontrol waktu layar bawaan di kedua platform',
    ...
    setupSub:
      'Tanpa kemampuan teknis — aplikasi memandu Anda di setiap langkah.',
    ...
    faq1A:
      'Ada. Uji coba dimulai saat perangkat orang tua dan anak pertama Anda tersambung, dan mencakup semua fitur Premium.',
  ...
  login: {
    ...
    resetNeedsEmail:
      'Masukkan alamat email Anda dulu, lalu pilih Lupa kata sandi.',
  ...
  authError: {
    ...
    operationNotAllowed:
      'Metode masuk itu belum diaktifkan untuk proyek ini.',
    unauthorizedDomain:
      'Domain ini tidak diizinkan di pengaturan Firebase Authentication.',
    invalidCustomToken:
      'Tautan masuk itu sudah tidak berlaku. Tampilkan kode QR baru.',
  ...
  perm: {
    ...
    camera: 'Kamera',
    backgroundAppRefresh: 'Penyegaran aplikasi latar belakang',
    overlay: 'Tampilkan di atas aplikasi lain',
    batteryOptimization: 'Baterai tanpa batasan',
    exactAlarm: 'Alarm presisi',
