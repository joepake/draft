...
export default {
  ...
  nav: {
    ...
    privacy: 'Privacidade',
    terms: 'Termos',
    signIn: 'Entrar como responsável',
  },
  ...
  footer: {
    ...
    madeFor: 'Feito para famílias no iOS e no Android.',
  },
  ...
  home: {
    ...
    feature6Title: 'Relatório de trajetos',
    feature6Text:
      'Trajetos, distância e a maior média entre pontos de localização — o bastante para puxar conversa, não um radar.',
    ...
    setupSub:
      'Sem conhecimento técnico — o app conduz você em cada passo.',
    ...
    faq1A:
      'Sim. O teste começa quando seus primeiros aparelhos de responsável e de filho são conectados, e inclui todos os recursos Premium.',
  ...
  login: {
    ...
    resetNeedsEmail:
      'Digite seu e-mail primeiro e depois escolha Esqueceu a senha.',
  ...
  authError: {
    ...
    invalidCustomToken:
      'Esse link de login não é mais válido. Mostre um novo QR code.',
  ...
  dash: {
    ...
    attnBatteryLowMeta: 'As atualizações de localização podem parar se o celular desligar',
    attnReview: 'Revisar',
    attnResend: 'Reenviar',
    ...
    rowAppBlockingDesc:
      '{{apps}} apps · {{categories}} categorias selecionadas no aparelho da criança',
