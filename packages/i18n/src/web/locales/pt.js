...
export default {
  ...
  home: {
    ...
    feature4Text:
      'Recuse sites adultos e de apostas e depois veja quais sites o aparelho realmente consultou e quais foram barrados.',
    ...
    feature7Text:
      'Saiba na hora em que uma permissão importante é desligada — e, no Android, quando um app é instalado ou removido.',
    ...
    feature12Text:
      'Tudo o que aconteceu, em ordem: um aparelho desbloqueado, um site filtrado, uma tarefa concluída, um alerta enviado.',
    platformsTitle: 'Um só KidGate, onde estiver a tela',
    platformsSub:
      'As mesmas regras e a mesma conta de família no celular e no computador. O app de computador é instalado por este site, não por uma loja.',
    ...
    why1Text:
      'Uma única assinatura cobre todos os aparelhos de pais e filhos. Só o titular da família paga.',
    ...
    faq1A:
      'Sim. O teste começa quando seus primeiros aparelhos de responsável e de filho são conectados, e inclui todos os recursos Premium. Quando termina, o Limite diário, os Horários bloqueados e a localização continuam de graça em um aparelho da criança.',
    faq2Q: 'Quantos aparelhos posso gerenciar?',
    faq2A:
      'Uma assinatura cobre a família inteira — vários aparelhos de filhos e vários responsáveis no mesmo plano.',
    ...
    faq4A:
      'Você pode entrar no painel web para ler relatórios. Mudar limites ou bloquear um aparelho é aprovado pelo seu celular, então uma senha roubada nunca basta.',
    faqMore: 'Mais dúvidas? Veja o Suporte',

    ctaTitle: 'Comece a proteger sua família hoje',
    ctaSub: 'Teste gratuito com acesso completo. Sem cartão de crédito para começar.',
  ...
  login: {
    ...
    qrWhy:
      'Aprovar pelo celular é a única forma de liberar os controles — bloquear um aparelho e mudar limites continuam sendo do app. Os métodos abaixo entram apenas para ver relatórios.',
    orViewOnly: 'ou entrar somente para visualizar',
  ...
  dash: {
    ...
    unlock: 'Desbloquear',
    working: 'Processando…',
    lockNeedsApp: 'Bloquear exige o app do KidGate no seu celular',

    viewOnlyTitle: 'Somente visualização.',
    viewOnlyBody:
      'Para bloquear um aparelho, mudar limites ou aprovar pedidos, saia e entre de novo lendo o QR code com o app do KidGate — a aprovação de um celular de responsável já conectado é o que libera os controles. Os Check-Ins funcionam daqui de qualquer forma.',
    ...
    attnPermissionOff: '{{permission}} está desligado',
    attnPermissionOffMeta:
      'A proteção fica mais fraca até isso ser restaurado no aparelho da criança',
    ...
    toggleInApp: 'Mude isso no app do KidGate',
    ...
    approve: 'Aprovar',
    approveInApp: 'Aprove no app do KidGate',
  ...
  controlError: {
    ...
    network: 'Sem ligação. Verifique a sua rede e tente novamente.',
    sessionExpired: 'A sua sessão expirou. Inicie sessão novamente.',
    forbidden:
      'Esta sessão do navegador não pode fazer alterações. Inicie sessão novamente lendo o código QR com a app KidGate.',
    notFound: 'Isso já não existe — pode ter sido alterado no telemóvel.',
    conflict: 'Alguém acabou de alterar isto. Recarregue para ver o resultado.',
    rateLimited:
      'Demasiadas alterações de uma vez. Aguarde um momento e tente novamente.',
    server: 'O KidGate não conseguiu concluir. Tente novamente em breve.',
  },
  ...
  report: {
    ...
    weekOf: 'Semana {{week}}',
    range: '{{from}} – {{to}}',
    writtenAt: 'Escrito a {{when}}',
    triggerScheduled: 'Enviado no domingo',
    triggerManual: 'Criado por si',
    statScreenTime: 'Tempo de ecrã',
    statDailyAverage: 'Média diária',
    statBlockedApps: 'Apps bloqueadas',
    statBlockedWebVisits: 'Sites filtrados',
    trendUp: '{{value}} a mais do que na semana anterior',
    trendDown: '{{value}} a menos do que na semana anterior',
    trendFlat: 'Praticamente igual à semana anterior',
    trendFirstWeek: 'Primeira semana medida',
    barThisWeek: 'Esta semana',
    barLastWeek: 'Semana passada',
    highlights: 'Vale a pena saber',
    sevAttention: 'Merece atenção',
    sevNotable: 'A destacar',
    sevInfo: 'Bom saber',
    findingUsageUp:
      'O tempo de ecrã subiu {{percent}}% — {{delta}} a mais do que na semana passada.',
    findingUsageDown:
      'O tempo de ecrã desceu {{percent}}% — {{delta}} a menos do que na semana passada.',
    findingUsageFlat: 'O tempo de ecrã manteve-se em {{total}}.',
    findingLateNight_one: 'Uma noite depois das 23:00, até às {{time}}.',
    findingLateNight_other:
      '{{count}} noites depois das 23:00; a mais tardia até às {{time}}.',
    findingNewTopApp: '{{app}} é nova esta semana e já leva {{duration}}.',
    findingAppSurge:
      '{{app}} subiu {{delta}} face à semana passada — {{duration}} no total.',
    findingLimitHit_one: 'O limite diário de {{limit}} foi atingido num dia.',
    findingLimitHit_other:
      'O limite diário de {{limit}} foi atingido em {{count}} dias.',
    findingBlockedApps:
      '{{count}} aberturas de apps bloqueadas, face a {{previous}} na semana passada.',
    findingBlockedWeb:
      '{{count}} sites filtrados, face a {{previous}} na semana passada.',
    findingQuietWeek:
      'Uma semana calma — {{total}} ao todo e nada que precisasse de si.',
    narrativeTitle: 'Numa frase',
    finePrint:
      'Os números abrangem de {{from}} a {{to}}, em todos os dispositivos da família. O tempo de ecrã é o que os dispositivos reportaram; os minutos que não conseguiram medir não entram em nenhum total.',
    generate: 'Escrever o relatório desta semana',
    generating: 'A escrever…',
    shareImage: 'Guardar como imagem',
    sharePdf: 'Guardar como PDF',
    copySummary: 'Copiar resumo',
    copied: 'Resumo copiado.',
    imageSaved: 'Imagem guardada.',
    shareFailed: 'Este navegador não consegue guardar isso. Copie antes o resumo.',
    emptyTitle: 'Ainda sem relatório',
    emptyBody:
      'Chega um relatório todos os domingos à noite. Pode escrever o desta semana agora — abrange os últimos sete dias.',
    noUsage:
      'Não foi registado tempo de ecrã nas últimas duas semanas, por isso ainda não há nada a relatar. Um dispositivo desligado não reporta nada, o que não é o mesmo que uma semana calma.',
    rateLimited: 'Demasiadas tentativas. Aguarde um minuto.',
    failed: 'Não foi possível escrever o relatório. Tente novamente daqui a pouco.',
    existed: 'Esta semana já tinha um relatório — aqui está.',
    childrenTitle: 'Cada filho',
    childrenNote:
      'A mesma quinzena, por dispositivo. As percentagens são do total da família.',
    colChild: 'Filho',
    colScreenTime: 'Tempo de ecrã',
    colShare: 'Proporção',
    colChange: 'Face à semana passada',
    colLimit: 'Acima do limite',
    colLateNights: 'Noites tarde',
    colTopApp: 'Mais usada',
    unnamedChild: 'Dispositivo sem nome',
    changeUp: '+{{value}}',
    changeDown: '−{{value}}',
    changeFlat: 'praticamente igual',
    noLimit: 'Sem limite',
    noTopApp: '—',
    limitDays_one: '{{count}} dia',
    limitDays_other: '{{count}} dias',
    lateNightsNone: 'nenhuma',
    busiest: 'Mais tempo de ecrã',

    historyTitle: 'Semanas anteriores',
    historyEmpty:
      'Os relatórios que receber a partir de agora ficam aqui durante um ano.',
  },
  ...
  support: {
    ...
    faq4A:
      'O teste começa quando seus primeiros aparelhos de responsável e de filho são conectados e dá acesso completo a todos os recursos. Remover um aparelho de filho não reinicia o teste. Quando ele acabar, assine o Premium para continuar usando o KidGate.',
  ...
  download: {
    ...
    button: 'Baixar',
    warningSub:
      'Os dois sistemas mostram esse aviso para qualquer app instalado fora das lojas deles por um desenvolvedor que ainda não está nas listas verificadas — ele não aponta nada encontrado no KidGate. Cada card acima explica como permitir a primeira execução. Baixe somente em kidgate.app.',
    macosSteps:
      'Abra o app uma vez e deixe ser recusado. Depois vá em Ajustes do Sistema, Privacidade e Segurança, role para baixo e escolha Abrir Mesmo Assim.',
    windowsSteps:
  ...
  about: {
    ...
    storyP3:
      'Ele roda em iPhone, Android, Mac e Windows, com um painel que abre em qualquer navegador. Uma família, um plano, todos os aparelhos.',
    ...
    value4Text:
      'Uma assinatura cobre todos os responsáveis e todos os aparelhos das crianças. Limite diário, Horários bloqueados e localização continuam funcionando de graça, então os recursos de segurança nunca ficam atrás do paywall.',
    ...
    make5Text:
      'A tela da sala, tratada como um aparelho compartilhado da família e não de uma criança só — com os mesmos limites e os mesmos horários dos celulares.',
    make6Title: 'Painel dos pais',
    make6Text:
