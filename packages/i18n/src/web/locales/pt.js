...
export default {
  ...
  dash: {
    ...
    webActivitySyncNoteTv:
      'Esta TV só se conecta periodicamente, então a atividade na web pode levar até 30 minutos para aparecer nesta tela — mais tempo sem conexão com a internet.',
    colDomain: 'Domínio',
    colVisits: 'Visitas',
