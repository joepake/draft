...
export default {
  ...
  report: {
    ...
    noUsage:
      'No se registró tiempo de pantalla en las últimas dos semanas, así que todavía no hay nada que informar. Un dispositivo apagado no informa nada, y eso no es lo mismo que una semana tranquila.',
