...
export default {
  ...
  home: {
    ...
    trust3Title: 'الهاتف والحاسوب والمتصفح',
    trust3Text: 'iPhone وAndroid وMac وWindows وChrome في حساب عائلي واحد',
    ...
    feature4Text:
      'ارفض مواقع البالغين والمقامرة على الهاتف وعلى الحاسوب وداخل Chrome، ثم اطّلع على المواقع التي جرى طلبها وتلك التي أُوقفت.',
    ...
    feature7Text:
      'اعرف في اللحظة التي يُطفأ فيها إذن مهم — وعلى Android وMac وWindows، حين يظهر تطبيق جديد وينتظر موافقتك.',
    ...
    platformsSub:
      'القواعد نفسها والحساب العائلي نفسه على الهاتف وعلى الحاسوب وداخل Chrome. تطبيق الحاسوب يُثبَّت من هذا الموقع لا من متجر.',
    ...
    only1Text:
      'يحصل Android TV على ساعات الحظر نفسها وحظر التطبيقات وحدود كل تطبيق وتصفية الويب كما في الهاتف. والنسخة تعمل اليوم على جهاز حقيقي وتنتظر إصدارها في المتجر، ولهذا تذكر قائمة المنصات أنها قيد التخطيط. معظم أدوات الرقابة الأبوية تتوقف عند الهاتف.',
  ...
  report: {
    ...
    emptyBody:
      'يصل تقرير كل صباح اثنين. ويمكن كتابة تقرير هذا الأسبوع الآن — وهو يغطي الأيام السبعة الماضية.',
    noUsage:
