...
export default {
  ...
  meta: {
    ...
    description:
      'يساعد KidGate الآباء على إدارة وقت استخدام الشاشة وحظر التطبيقات وفلتر الويب والبقاء على تواصل — دون أن يسلب الطفل حريته.',
  },
  ...
  home: {
    ...
    only1Text:
      'يحصل Android TV على الحد اليومي وساعات الحظر وحظر التطبيقات وفلتر الويب. والحظر على التلفاز في حدود المستطاع — يُعاد التطبيق المحظور إلى الشاشة الرئيسية — ولا يوجد SOS ولا طلب وقت إضافي من الأريكة. والنسخة تعمل اليوم على جهاز حقيقي وتنتظر إصدارها في المتجر. معظم أدوات الرقابة الأبوية تتوقف عند الهاتف.',
    ...
    only4Text:
      'الضغط المطوّل على SOS خمس ثوانٍ يصلك فورًا مع الموقع — وعلى Android وMac يُفتح قفل الجهاز أيضًا لفترة قصيرة. الطفل الذي يستطيع طلب المساعدة من شاشة القفل لا سبب لديه ليقاوم التطبيق.',
  ...
  dash: {
    ...
    noDeviceBody:
      'افتح KidGate على هاتفك، وانتقل إلى *العائلة*، واضغط على أيقونة المسح (*مسح رمز*)، ثم امسح رمز QR الظاهر على جهاز طفلك. سيظهر هنا بعد ثوانٍ من الربط.',
  ...
  support: {
    ...
    start3:
      '**3. اربط جهاز الطفل.** ثبّت KidGate على جهاز طفلك واختر *هذا جهاز طفل*. من جهاز ولي الأمر، افتح *العائلة* واضغط على أيقونة المسح (*مسح رمز*)، ثم امسح رمز QR الظاهر على جهاز الطفل (أو أدخل الرمز المكوّن من 6 أحرف). أكّد الاتصال على جهاز الطفل.',
    start4:
    ...
    faq2A:
      'على جهاز الطفل، افتح KidGate واختر *هذا جهاز طفل* — سيظهر رمز QR ورمز من 6 أحرف. من جهاز ولي الأمر، افتح *العائلة* واضغط على أيقونة المسح (*مسح رمز*)، ثم امسح رمز QR (مستحسن) أو أدخل الرمز يدويًا. ثم أكّد اسم ولي الأمر على جهاز الطفل. تنتهي صلاحية الرموز — فإن فشل الربط، اضغط *رمز جديد* على جهاز الطفل وأعد المحاولة.',

    faq3Q: 'هل يستطيع وليّا أمر إدارة العائلة نفسها؟',
    faq3A:
      'نعم. من جهاز مالك العائلة، افتح *العائلة ← + ← دعوة أحد الوالدين* وشارك رمز QR أو رمز الدعوة. يثبّت ولي الأمر الآخر KidGate ويسجّل الدخول كولي أمر، ثم يفتح *العائلة* ويضغط على أيقونة المسح (*مسح رمز*)، ثم يمسح رمز QR أو يكتب رمز الدعوة هناك. بعدها يعتمد المالك الطلب. اشتراك واحد يغطي العائلة كلها؛ ويدفع المالك وحده.',
  ...
  download: {
    ...
    macosSteps:
      'افتح الحزمة التي نزّلتها واتبع خطوات المثبِّت. بعدها يطلب منك macOS مرة واحدة السماح بامتداد نظام KidGate، من Login Items & Extensions — ولا يعمل فلتر الويب قبل أن تفعل ذلك.',
  ...
  about: {
    ...
    storyP2:
      'لذلك بنينا النسخة التي أردناها في بيوتنا. يضبط ولي الأمر الحد اليومي وساعات الحظر وحظر التطبيقات وفلتر الويب مرة واحدة، ويلتزم الجهاز بها. ويرى الطفل الأرقام نفسها التي يراها والداه، ويستطيع طلب وقت إضافي، ويصل إلى والديه عبر SOS متى كان الجهاز متصلًا بالإنترنت. لا يتظاهر KidGate بأنه غير موجود.',
    storyP3:
    ...
    value2Text:
      'بلا إعلانات إطلاقًا. لا يُستخدم أي شيء يخص طفلًا في الإعلانات ولا يُباع لأحد. ويمكنك طلب حذف حساب العائلة وكل ما فيه في أي وقت — من داخل التطبيق أو من هذا الموقع — ويختفي بعد 14 يومًا.',
    ...
    value4Text:
      'اشتراك Premium واحد يغطي كل الآباء والأمهات وكل أجهزة الأبناء. ويستمر الحد اليومي وساعات الحظر والتطبيقات المحظورة وفلتر الويب في العمل مجانًا على جهاز طفل واحد، فلا تقع قواعد السلامة خلف جدار الدفع أبدًا.',
    ...
    make6Title: 'Chrome',
    make6Text:
      'إضافة متصفح تحمل فلتر الويب نفسه داخل Chrome، على حاسوب مثبَّت عليه KidGate وعلى حاسوب لا يمكن تثبيته عليه. اكتمل بناؤها ورُبطت بالعائلة، وتنتظر مراجعة Chrome Web Store.',
