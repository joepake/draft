  ...
  privacyPolicy: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Os registros expiram conforme um cronograma e são excluídos automaticamente: Tempo de tela e uso por app, histórico da web, histórico de vídeos, histórico de localização e o feed de atividades após 30 dias; alertas de SOS, Check-ins de segurança e pedidos de tempo extra após 90 dias; relatórios semanais após 365 dias. Os códigos de emparelhamento expiram em poucos minutos e um login pelo navegador dura 7 dias. Alguns registros hoje não têm prazo de expiração e são mantidos até a exclusão da conta de família: a conta e suas configurações, os lugares salvos, os cadastros de crianças e dispositivos, as tarefas com recompensa, os pedidos de sites, os quadros de estrelas e os quadros de tempo de tela, e a lista de apps. As solicitações de suporte, as respostas e qualquer captura de tela anexada são excluídas 90 dias após a solicitação ser resolvida. Registros limitados também podem permanecer quando exigido por lei, para prevenção de fraudes, backups rotativos ou transações da loja de aplicativos.',
      },
      {
