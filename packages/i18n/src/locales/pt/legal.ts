export const legal = {
  privacyPolicy: {
    ...
    effectiveDate: 'Em vigor a partir de 15 de agosto de 2026',
    intro:
      'KidGate é o nome comercial e de produto utilizado pelo desenvolvedor independente que opera o aplicativo. Esta política explica como o KidGate trata os dados quando os pais utilizam o serviço para gerenciar o dispositivo de um filho.',
    sections: [
      {
      ...
      {
        title: '2. Dados que podemos processar',
        body: 'Dependendo dos recursos ativados e das permissões concedidas, os dados podem incluir identificadores de conta e dados de login do Google ou da Apple; identificadores e nomes de dispositivos; status de emparelhamento; configurações de limites; atividade de apps e tempo de tela; sites solicitados pelo dispositivo da criança e quais deles foram filtrados; localização e histórico de localização; alertas de SOS, de área, de adulteração e de proteção; fotos feitas no dispositivo da criança quando um SOS ou um check-in de segurança é enviado; os nomes que um responsável dá a cada criança, os dispositivos atribuídos a elas e os totais semanais de estrelas do quadro de estrelas; tarefas com recompensa, pedidos de tempo extra e os relatórios semanais que resumem tudo isso; diagnósticos técnicos, falhas, versão do app e dados de transações de assinatura fornecidos por uma loja de aplicativos. O KidGate não exige o nome real de uma criança quando um recurso não precisa dele.',
      },
      {
        title: '3. Como os dados são utilizados',
        body: 'Os dados dão suporte à autenticação, ao pareamento de dispositivos, aos controles parentais, à sincronização de configurações, a alertas, relatórios, assinaturas, prevenção de fraudes, segurança da conta, solução de problemas e confiabilidade. O KidGate não vende dados pessoais nem utiliza dados de crianças para publicidade comportamental.',
      },
      {
        title: '4. Bases legais e consentimento',
        body: 'O KidGate processa dados para prestar os serviços solicitados, cumprir obrigações legais, proteger interesses legítimos de segurança e proteção, ou com base no consentimento, quando exigido. Os pais são responsáveis por fornecer os avisos exigidos e obter o consentimento válido em nome de uma criança ou usuário do dispositivo.',
      },
      {
        title: '5. Prestadores de serviços e divulgação',
        body: 'Os dados são divulgados apenas conforme necessário a provedores de infraestrutura, autenticação, armazenamento em nuvem, notificações, análise de falhas, pagamento ou loja de aplicativos; a autoridades quando legalmente exigido; ou para tratar de questões de segurança, fraude ou abuso. Os provedores têm seus próprios deveres e políticas. Eles não estão autorizados pelo KidGate a utilizar dados de crianças para fins de marketing independente.',
      },
      {
        title: '6. Armazenamento, transferências e segurança',
        body: 'Os dados podem ser armazenados ou processados fora do país do usuário. O KidGate utiliza salvaguardas técnicas e organizacionais razoáveis, incluindo controles de acesso, práticas de privilégio mínimo e transporte seguro quando suportado pela plataforma. Nenhum sistema é completamente seguro; o KidGate não pode garantir que os dados nunca serão perdidos, acessados sem autorização ou interrompidos. O pessoal autorizado da KidGate pode aceder à configuração da conta, aos dispositivos e aos dados de atividade nela apresentados quando necessário para responder a um pedido de apoio ou diagnosticar uma falha técnica. Este acesso está limitado a pessoal autorizado, é utilizado exclusivamente para fins de apoio e fica registado.',
      },
      {
        title: '7. Retenção e exclusão',
        body: 'Os dados são retidos conforme necessário para prestar o serviço, manter a segurança, resolver disputas e cumprir obrigações legais. Os pais podem solicitar a exclusão da conta em Configurações. Registros limitados podem permanecer quando exigido por lei, para prevenção de fraudes, backups rotativos ou transações da loja de aplicativos.',
      },
      {
        title: '8. Direitos e escolhas',
        body: 'Dependendo da legislação aplicável, os usuários podem solicitar acesso, correção, exclusão, restrição, oposição ou retirada do consentimento. As permissões de localização, notificação e dispositivo podem ser desativadas no sistema operacional, mas os recursos relacionados podem parar de funcionar ou ficar incompletos.',
      },
      {
  ...
  termsOfService: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'O KidGate fornece ferramentas que ajudam os pais a gerenciar dispositivos, definir limites, visualizar o status e receber alertas. Ele não substitui a supervisão direta, o aconselhamento médico, os serviços de emergência, a aplicação da lei ou serviços profissionais de proteção infantil.',
      },
      {
        title: '3. Responsabilidades dos pais',
        body: 'Você deve dar o aviso adequado às crianças, obter o consentimento exigido, configurar as permissões corretamente, testar os recursos e cumprir as leis de privacidade, monitoramento, trabalho, educação e proteção infantil. Não utilize o KidGate para monitoramento oculto, assédio, controle ilegal ou violação dos direitos de terceiros.',
      },
      {
        title: '4. Segurança da conta',
        body: 'Você é responsável pela atividade da conta e por proteger dispositivos, PINs e métodos de login. Relate prontamente qualquer suspeita de acesso não autorizado. O KidGate pode restringir temporariamente contas ou dispositivos para proteger os usuários ou investigar abusos.',
      },
      {
        title: '5. Permissões de plataforma e limitações técnicas',
        body: 'Os recursos dependem de permissões do sistema operacional, acesso à rede, estado da bateria, configurações do fabricante, serviços de localização e plataformas de terceiros. Os alertas podem ser atrasados, incompletos ou imprecisos. Você deve verificar os dispositivos diretamente e não deve depender exclusivamente do KidGate para segurança ou emergências.',
      },
      {
        title: '6. Assinaturas e pagamentos',
        body: 'Compras, renovações, cancelamentos e reembolsos são tratados de acordo com os termos da Apple App Store, do Google Play ou do provedor de pagamento correspondente. Os preços e recursos dos planos podem mudar após o aviso exigido por lei e pelas regras das lojas.',
      },
      {
        title: '7. Licença e propriedade',
      ...
      {
        title: '13. Rescisão e disputas',
        body: 'Você pode deixar de utilizar o serviço e solicitar a exclusão da conta. O KidGate pode suspender ou encerrar o serviço em caso de violações, riscos à segurança ou exigências legais. As partes devem primeiro tentar resolver disputas de boa-fé; a legislação e os tribunais competentes são determinados pelas regras obrigatórias aplicáveis ao usuário e ao operador.',
      },
      {
      ...
      {
        title: '15. Software de terceiros',
