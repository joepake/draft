export const report = {
  ...
  findingQuietWeek:
    'Uma semana tranquila: {{total}} no total e nada que exigisse sua atenção.',
  ...
  currentWeekBody: 'O relatório desta semana chega {{day}}.',
  currentWeekNote:
    'Ele cobre de segunda a domingo, em todos os aparelhos da família. Nada está faltando ainda — a semana não terminou.',
  ...
  hubChildUnassigned: 'Nenhum dispositivo atribuído',
  ...
  guestDescription:
    'Entre para medir hoje contra um dia normal, comparar seus filhos lado a lado e receber um relatório toda segunda-feira.',
  ...
  guestBenefitWeeklyTitle: 'Um relatório toda segunda-feira',
