...
export const errors = {
  ...
  premiumSubscriptionRequired:
    'Este recurso precisa do Premium. Todas as regras que você definiu — limites, horário de dormir, bloqueio de apps, filtro da web, localização e SOS — continuam grátis.',
