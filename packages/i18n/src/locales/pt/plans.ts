export const plans = {
  ...
  statusTrialEndedSubtitle:
    'O Limite diário, os Horários bloqueados e a localização continuam funcionando de graça. Assine para ter de volta Apps bloqueados, Filtro da web, alertas e relatórios.',
  ...
  planTrialName: 'Teste',
  planTrialMeta: 'Grátis · {{days}} dias · Acesso completo',
  ...
  sectionIncludedFeaturesSubtitle:
    'Tudo abaixo está incluído tanto no Teste quanto no Premium.',
  footerLegal:
  ...
  featureUsageReports: 'Relatórios de uso',
  featureActivityFeed: 'Feed de atividades',
  featureParentPinProtection: 'Proteção por PIN dos pais',
  trialPlanName: 'Teste',
  trialDescription:
  ...
  subscribeToContinue:
    'Você está no plano gratuito. Assine para desbloquear tudo de novo.',
  ...
  memberTrialActiveSubtitle:
    'Esta família está em teste. Quando ele terminar, o dono precisará assinar para continuar usando o KidGate.',
  memberTrialEndedSubtitle:
    'O teste desta família terminou. O Limite diário, os Horários bloqueados e a localização continuam funcionando. Peça ao proprietário para assinar e ter o restante.',
  ...
  familyPremiumEndedBody:
    'O Limite diário, os Horários bloqueados e a localização continuam funcionando. Apps bloqueados, Filtro da web, alertas e relatórios ficam pausados até o proprietário renovar o Premium.',
