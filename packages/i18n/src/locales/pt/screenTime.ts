export const screenTime = {
  ...
  screenTimeSetupStep2:
    'Quando solicitado, selecione Permitir na caixa de diálogo de Uso de apps e sites.',
  screenTimeSetupStep3: 'Volte aqui depois que a caixa fechar.',
  screenTimeDeniedStep1: 'Selecione Abrir ajustes do app abaixo.',
  screenTimeDeniedStep2: 'Na página do {{appName}}, ative Tempo de Uso.',
  screenTimeDeniedStep3: 'Volte ao {{appName}} — este cartão desaparecerá.',
  screenTimeBannerTitleDenied: 'Ativar o Tempo de Uso',
  screenTimeBannerTitleRequest: 'Permitir uso de apps e sites',
  ...
  usageAccessStepOpenSettings: 'Selecione Abrir Ajustes abaixo.',
  usageAccessStepFindKidGate: 'Encontre o KidGate e ative o Acesso de uso.',
  usageAccessStepReturn: 'Volte aqui — o status é atualizado automaticamente.',
  noDailyLimitSet: 'Sem Limite diário',
  limitReachedStatus: '{{used}} / {{limit}} · Limite atingido',
