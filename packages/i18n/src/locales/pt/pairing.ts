export const pairing = {
  ...
  shareInviteMessage:
    'Entre na nossa família no KidGate: abra o app, vá em Família → Escanear código, depois escaneie o código QR ou digite o código {{code}}. O código expira em 15 minutos.',
