export const permissions = {
  ...
  oemAutostartHintVivo:
    'Em Inicialização automática / Alto consumo em segundo plano, permita o KidGate.',
  oemAutostartHintHuawei:
    'Em Inicialização de apps / Gerenciador de inicialização, defina o KidGate como Gerenciar manualmente e permita todas as opções.',
