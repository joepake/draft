export const usage = {
  ...
  chartNoDataYet:
    'As barras são preenchidas à medida que o dispositivo da criança sincroniza o uso diário. A barra de hoje é atualizada com os minutos em tempo real.',
