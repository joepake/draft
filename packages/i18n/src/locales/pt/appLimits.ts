export const appLimits = {
  ...
  addSectionTitle: 'Adicionar um limite',
  ...
  increaseAccessibility: 'Aumentar o limite de {{app}}',
  decreaseAccessibility: 'Reduzir o limite de {{app}}',
  addAccessibility: 'Adicionar um limite diário para {{app}}',
} as const;
