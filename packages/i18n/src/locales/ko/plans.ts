export const plans = {
  ...
  statusTrialEndedSubtitle:
    '일일 제한, 차단 시간, 차단된 앱, 웹 필터, 위치는 무료로 계속 사용할 수 있습니다. 실시간 업데이트, 기록, 알림, 리포트를 쓰려면 구독하세요.',
  ...
  compareActivityFeed: '활동 내역',
  compareActivityFeedFree: '오늘',
  ...
  groupLiveTitle: '실시간',
  groupInsightTitle: '모든 세부 정보',
  groupAlertsTitle: '알림',
  groupDevicesTitle: '모든 기기',
  ...
  subscribeToContinue:
    '지금은 무료 플랜입니다. 규칙은 계속 작동합니다 — 구독하면 실시간 활동, 기록, 리포트를 볼 수 있습니다.',
  ...
  familyPremiumEndedBody:
    '일일 제한, 차단 시간, 차단된 앱, 웹 필터, 위치는 계속 사용할 수 있습니다. 실시간 업데이트, 기록, 알림, 리포트는 가족 관리자가 Premium을 갱신할 때까지 멈춥니다.',
