export const plans = {
  ...
  featureWebHistory: '웹 기록',
  featureWeeklyReport: '주간 리포트',
  featureChildReport: '자녀별 리포트',
  featureStarChart: '별 순위표',
  featureFootnoteAppLimits:
    '앱 시간 제한은 Android 기기나 Mac에서 작동합니다. Apple 스크린 타임은 iPhone이나 iPad에서 어떤 앱이 열려 있는지 알려주지 않습니다.',
