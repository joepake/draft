export const messageMonitoring = {
  ...
  guidanceToggle: '다음에 할 일',
  guidanceHide: '숨기기',
  guidanceFooter:
    'KidGate는 메시지 내용을 저장하지 않았습니다. 남은 것은 이 단어뿐이며, 그 이상은 자녀에게 들어야 합니다.',
  guidance: {
    predator:
      '접근은 대개 친근하게 시작되고, 자녀가 또래라고 믿는 사람에게서 옵니다. 알림을 언급하기 전에 요즘 누구와 이야기하는지, 둘이 어떻게 알게 되었는지 물어보세요. 들켰다고 느끼면 아이는 말을 멈춥니다.',
    selfHarm:
      '이런 단어는 계획보다 신호인 경우가 훨씬 많고, 직접 물어보는 것이 그 생각을 심지는 않습니다. 무엇을 보았는지, 그리고 화가 나지 않았다는 점을 말해 주세요. 대답이 걱정된다면 같은 날 위기상담 전화로 연락하세요.',
    explicit:
      '누군가 보낸 것일 수도, 보여 준 것일 수도, 자녀가 직접 쓴 것일 수도 있습니다. 반응하기 전에 어느 쪽인지 확인하세요. 받은 것과 보낸 것은 서로 다른 대화입니다.',
    violence:
      '친구 사이의 농담처럼 보여도 위협은 진지하게 볼 가치가 있습니다. 학교에 있는 사람에게서 온 것인지 물어보세요. 그렇다면 학교가 가장 빠르게 멈출 수 있는 길입니다.',
    bullying:
      '아이들은 이런 일을 스스로 말하는 경우가 드물고, 자녀가 대상이었을 때나 함께했을 때나 같은 단어가 나타납니다. 누구의 잘못인지보다 무슨 일이 있었는지 묻고, 학교에 필요할 수 있으니 날짜를 적어 두세요.',
    drugs:
      '표시된 단어 하나가 사용의 증거는 아닙니다. 호기심이나 노래, 농담도 같은 단어를 만듭니다. 방을 뒤지기보다 솔직하게 물어보세요. 가장 중요한 것은 자녀가 계속 이야기해 주는 것입니다.',
    alcohol:
      '청소년의 평범한 대화에서 흔한 주제이므로 증거가 아니라 맥락으로 읽으세요. 파티가 이 문제를 급하게 만들기 전에, 가정의 규칙을 분명히 말해 둘 좋은 시점입니다.',
    tobacco:
      '전자담배는 친구 무리를 통해 퍼지고 보통 비밀보다 사교적인 것입니다. 친구들이 무엇을 쓰는지 물어보세요. 일반적인 경고보다 구체적인 이름을 말하는 편이 더 잘 전달됩니다.',
    gambling:
      '확률형 아이템, 카드 팩, 아이템 베팅도 모두 해당되며 아이에게는 도박처럼 느껴지지 않는 경우가 많습니다. 돈 문제로 다루기 전에 게임 안에서 무엇에 쓰고 있는지 확인하세요.',
    profanity:
      '욕설 자체는 흔하고 안전에 대해 알려 주는 것이 거의 없습니다. 이 알림이 가족에게 소음일 뿐이라면 이 화면의 설정에서 “욕설도 함께 표시”를 끄세요.',
    unknown:
      '이 알림은 이 버전이 더 이상 이름을 갖고 있지 않은 기기나 단어 목록에서 왔습니다. 위에 표시된 단어가 물어볼 내용이며, 메시지의 다른 부분은 남아 있지 않습니다.',
  },
  setupTitle: '메시지 안전',
  setupBody:
  ...
  parentProfanityLabel: '욕설도 함께 표시',
  parentProfanityHint:
    '기본값은 꺼짐 — 일반적인 욕설은 흔하며, 켜면 이것도 알림 대상이 됩니다.',
