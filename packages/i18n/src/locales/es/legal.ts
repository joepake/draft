  ...
  privacyPolicy: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Cuando es necesario para atender una solicitud de soporte o diagnosticar un fallo, el personal autorizado de KidGate puede abrir una cuenta familiar y ver lo que ve un padre o madre: su configuración y sus dispositivos, y la actividad que contiene — incluidos el historial de ubicación, el historial web, las alertas de mensajes y las fotos adjuntas a un SOS o a un check-in. También puede cambiar ajustes y enviar comandos a los dispositivos. Este acceso se limita al personal autorizado, exige autenticación en dos pasos y se utiliza únicamente con fines de soporte. Abrir una cuenta familiar escribe una fila en el propio historial de actividad de esa familia, visible para sus padres, con la hora y la solicitud de soporte a la que corresponde; cada lectura de los registros de una familia a través de las herramientas del operador queda registrada con la hora y un motivo indicado. Las acciones concretas realizadas dentro de una sesión de soporte no se registran hoy por separado.',
      },
      {
        title: '11. Cuánto tiempo se conservan los datos',
        body: 'Los registros caducan según un calendario y se eliminan automáticamente: el Tiempo de uso y el uso por app, el historial web, el historial de vídeos, el historial de ubicación y el historial de actividad a los 30 días; las alertas SOS, los check-in de seguridad y las peticiones de tiempo extra a los 90 días; los informes semanales a los 365 días. Los códigos de vinculación caducan en cuestión de minutos y una sesión iniciada en el navegador dura 7 días cuando la ha concedido la app, u 8 horas cuando se ha desbloqueado con el PIN parental. Algunos registros no tienen hoy fecha de caducidad y se conservan hasta que se elimina la cuenta familiar: la cuenta y sus ajustes, los lugares guardados, las fichas de hijos y dispositivos, las tareas con recompensa, las peticiones de desbloqueo de sitios, la tabla de estrellas y el historial semanal de tiempo de uso, y la lista de apps instaladas en cada dispositivo. Las solicitudes de soporte, las respuestas y cualquier captura de pantalla adjunta se eliminan 90 días después de resolverse la solicitud. Un registro de que se solicitó y se completó la eliminación de una cuenta — un hash de la dirección de correo y las fechas, nada más — se conserva durante 12 meses tras completarse, para poder responder a una eliminación en disputa. También pueden conservarse registros limitados cuando lo exija la ley, para la prevención de fraude o para transacciones de la tienda de aplicaciones.',
      },
      {
        title: '12. Eliminación de una cuenta',
        body: 'Un padre o madre puede solicitar la eliminación en Configuración, desde kidgate.app o por correo a support@kidgate.app desde la dirección asociada a la cuenta. La solicitud queda en espera durante 14 días y puede cancelarse en ese plazo; después, se eliminan la cuenta familiar, cada hijo y dispositivo que dependen de ella y los archivos almacenados que le pertenecen, y se retira el propio inicio de sesión. La eliminación es permanente y después no hay exportación posible.',
      },
      {
        title: '13. Derechos y opciones',
        body: 'Según la ley aplicable, los usuarios pueden solicitar acceso, corrección, eliminación, restricción, oposición o retirada del consentimiento. Estas solicitudes, incluida la de una copia de los datos que se conservan sobre una familia, se dirigen a support@kidgate.app; hoy no existe una exportación de autoservicio. La supervisión de mensajes y la confirmación por IA pueden desactivarse en cualquier momento sin que ello afecte al resto del servicio. Los permisos de ubicación, notificaciones, cámara y dispositivo pueden desactivarse en el sistema operativo, pero las funciones que dependen de ellos dejarán de funcionar o quedarán incompletas, y KidGate lo indica en la pantalla del padre o madre en lugar de mostrar un control que ya no funciona.',
      },
      {
      ...
      },
      {
        ...
        body: 'Esta política puede cambiar a medida que cambien las funciones o las leyes. Las actualizaciones importantes se comunicarán en la aplicación o a través de un canal de distribución adecuado. Las solicitudes y preguntas relacionadas con la privacidad se dirigen a support@kidgate.app, la dirección publicada también en las fichas de KidGate en las tiendas de aplicaciones.',
      },
    ],
  },
  termsOfService: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Una prueba gratuita con acceso completo empieza cuando se vinculan sus primeros dispositivos de padre y de hijo, y dura el periodo indicado en la aplicación. Cuando termina, las reglas que configuró siguen funcionando sin pago en un dispositivo infantil — Límite diario, Horas bloqueadas, Apps bloqueadas, límites por app, el Filtro web, la búsqueda segura, el Bloqueo de dispositivo, las peticiones de tiempo extra, las tareas con recompensa y la supervisión de mensajes — y un padre o madre puede seguir pidiendo a ese dispositivo su posición actual un número limitado de veces al día. El SOS nunca está detrás de un pago. La actividad en vivo, el historial, los informes semanales, el rastro de ubicación, las direcciones y las alertas de lugares pasan a formar parte de Premium. Cuando una familia tiene más dispositivos infantiles de los que cubre el plan, los dispositivos adicionales quedan en pausa: siguen aplicando las reglas ya establecidas, esas reglas pueden relajarse pero no endurecerse, y dejan de enviar actividad. Usted elige qué dispositivo permanece supervisado, y esa elección puede cambiarse una vez cada siete días. Quitar un dispositivo infantil no reinicia la prueba. Una familia puede vincular un número limitado de dispositivos infantiles durante la vida de la cuenta; el número depende del plan, la aplicación lo indica cuando se alcanza, y un dispositivo que se quitó sigue contando para ese límite.',
      },
      {
        title: '8. Suscripciones y pagos',
        body: 'Las compras, renovaciones, cancelaciones y reembolsos se gestionan conforme a los términos de Apple App Store o Google Play, y una suscripción solo puede comprarse o restaurarse desde la app de KidGate para iPhone, iPad o Android — una familia cuyos dispositivos son todos ordenadores, televisores o Chromebooks necesita uno de esos para pagar. Una suscripción cubre a toda la familia y solo el titular de la familia puede comprarla o restaurarla; una compra intentada desde la cuenta de otro padre o madre se rechaza. Los planes mensual y anual se renuevan automáticamente salvo que se cancelen a través de la tienda al menos 24 horas antes de que termine el periodo. El pago único no se renueva, cubre el número de dispositivos infantiles indicado en la aplicación y dura mientras KidGate esté disponible; la sección 12 indica qué ocurre si eso termina. Los precios y las funciones de los planes pueden cambiar previo el aviso exigido por la ley y las normas de la tienda.',
      },
      {
      ...
      },
      {
        ...
        body: 'Estos términos pueden actualizarse. Los cambios importantes se comunicarán de manera adecuada; el uso continuado después de la fecha de vigencia implica la aceptación de los términos actualizados cuando la ley lo permita. Las preguntas se dirigen a support@kidgate.app.',
      },
    ],
  },
} as const;
