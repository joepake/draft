export const legal = {
  privacyPolicy: {
    ...
    effectiveDate: 'Vigente a partir del 15 de agosto de 2026',
    intro:
      'KidGate es el nombre de producto y comercial utilizado por el desarrollador independiente que opera la aplicación. Esta política explica cómo KidGate gestiona los datos cuando los padres utilizan el servicio para administrar el dispositivo de un hijo.',
    sections: [
      {
      ...
      {
        title: '2. Datos que podemos procesar',
        body: 'Según las funciones activadas y los permisos concedidos, los datos pueden incluir identificadores de cuenta y datos de inicio de sesión de Google o Apple; identificadores y nombres de dispositivo; estado de vinculación; ajustes de límites; actividad de apps y tiempo de pantalla; sitios web solicitados por el dispositivo infantil y cuáles de ellos se filtraron; ubicación e historial de ubicación; alertas de SOS, zonas, manipulación y protección; fotos tomadas en el dispositivo infantil al enviar un SOS o un control de seguridad; los nombres que un padre o madre da a cada hijo, los dispositivos asignados y los totales semanales de estrellas de la tabla de estrellas; tareas con recompensa, peticiones de tiempo extra y los informes semanales que resumen todo lo anterior; diagnósticos técnicos, fallos, versión de la app y datos de transacciones de suscripción facilitados por una tienda de aplicaciones. KidGate no exige el nombre real de un menor cuando una función no lo necesita.',
      },
      {
        title: '3. Cómo se utilizan los datos',
      ...
      {
        title: '4. Bases legales y consentimiento',
        body: 'KidGate procesa datos para prestar los servicios solicitados, cumplir con obligaciones legales, proteger intereses legítimos de seguridad, o sobre la base del consentimiento cuando así se requiera. Los padres son responsables de proporcionar los avisos requeridos y de obtener el consentimiento válido para un hijo o usuario del dispositivo.',
      },
      {
        title: '5. Proveedores de servicios y divulgación',
        body: 'Los datos se divulgan únicamente en la medida necesaria a proveedores de infraestructura, autenticación, almacenamiento en la nube, notificaciones, análisis de fallos, pagos o tiendas de aplicaciones; a las autoridades cuando la ley lo exija; o para abordar cuestiones de seguridad, fraude o abuso. Los proveedores tienen sus propias obligaciones y políticas. KidGate no los autoriza a utilizar los datos de los hijos para fines de marketing independientes.',
      },
      {
      ...
      },
      {
        ...
        body: 'Los datos se conservan durante el tiempo necesario para prestar el servicio, mantener la seguridad, resolver disputas y cumplir con obligaciones legales. Los padres pueden solicitar la eliminación de la cuenta en Configuración. Pueden conservarse registros limitados cuando lo exija la ley, para la prevención de fraude, copias de seguridad rotativas o transacciones de la tienda de aplicaciones.',
      },
      {
        title: '8. Derechos y opciones',
        body: 'Según la ley aplicable, los usuarios pueden solicitar acceso, corrección, eliminación, restricción, oposición o retirada del consentimiento. Los permisos de ubicación, notificaciones y dispositivo pueden desactivarse en el sistema operativo, pero es posible que las funciones relacionadas dejen de funcionar o queden incompletas.',
      },
      {
        title: '9. Datos de los hijos',
  ...
  termsOfService: {
    ...
    sections: [
      ...
      {
        title: '2. Finalidad del servicio',
        body: 'KidGate proporciona herramientas que ayudan a los padres a administrar dispositivos, establecer límites, ver el estado y recibir alertas. No sustituye la supervisión directa, el asesoramiento médico, los servicios de emergencia, las fuerzas del orden ni los servicios profesionales de protección infantil.',
      },
      {
        title: '3. Responsabilidades de los padres',
        body: 'Usted debe proporcionar el aviso adecuado a los hijos, obtener el consentimiento requerido, configurar los permisos correctamente, probar las funciones y cumplir con las leyes de privacidad, vigilancia, empleo, educación y protección infantil. No utilice KidGate para la vigilancia encubierta, el acoso, el control ilícito o la vulneración de los derechos de otra persona.',
      },
      {
      ...
      {
        title: '5. Permisos de la plataforma y limitaciones técnicas',
        body: 'Las funciones dependen de los permisos del sistema operativo, el acceso a la red, el estado de la batería, la configuración del fabricante, los servicios de ubicación y las plataformas de terceros. Las alertas pueden retrasarse, ser incompletas o inexactas. Usted debe verificar los dispositivos directamente y no debe depender únicamente de KidGate para la seguridad o las emergencias.',
      },
      {
        title: '6. Suscripciones y pagos',
        body: 'Las compras, renovaciones, cancelaciones y reembolsos se gestionan conforme a los términos de Apple App Store, Google Play o el proveedor de pagos correspondiente. Los precios y las funciones de los planes pueden cambiar previo el aviso exigido por la ley y las normas de la tienda.',
      },
      {
        title: '7. Licencia y propiedad',
