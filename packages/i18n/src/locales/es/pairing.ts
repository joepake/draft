export const pairing = {
  shareInviteButton: 'Compartir código',
  shareInviteMessage:
    'Únete a nuestra familia en KidGate: abre la app, ve a Familia → Escanear código, luego escanea el código QR o introduce el código {{code}}. El código caduca en 15 minutos.',
  ...
  confirmParentButton: 'Sí, conectar',
  rejectParentButton: 'No es este padre',
  ...
  manualCodeLabel: 'Código del dispositivo del niño',
  openingScanner: 'Abriendo la cámara…',
  cameraPermissionRequired:
    'Se requiere acceso a la cámara para escanear el código QR.',
  unableToOpenScanner: 'No se pudo abrir el escáner de la cámara.',
  newCode: 'Nuevo código',
  done: 'Listo',
  unableToCreateCode: 'No se pudo crear un código. Inténtalo de nuevo.',
  inviteParentTitle: 'Añadir otro dispositivo de padre o madre',
  inviteParentInstructions:
    'En el otro dispositivo, abre KidGate → Familia → Escanear código, luego escanea este código QR o introduce el código en un plazo de 15 minutos. Aprueba la solicitud aquí para conectar a ese padre o madre.',
  inviteCodeLabel: 'O comparte este código',
  joinFamilyTitle: 'Unirse a una familia',
  joinFamilyScanInstructions:
    'Escanea el código QR de invitación de un padre o madre que ya esté en esa familia.',
  joinFamilyManualInstructions:
    'Introduce el código de invitación de 6 caracteres de un padre o madre que ya esté en esa familia.',
  joinFamilyCodeLabel: 'Código de invitación de un padre o madre',
  joinFamilyButton: 'Unirse a una familia',
  parentJoinRequest: 'Esperando la aprobación del propietario',
  parentJoinApprove: 'Aprobar',
  parentJoinDecline: 'Rechazar',
  parentJoinRejected: 'El propietario de la familia rechazó tu solicitud.',
  parentJoinExpired:
    'La solicitud de aprobación ha caducado. Pide una nueva invitación.',
  unableToResolveParentJoin: 'No se pudo resolver esta solicitud.',
  joinedFamily:
