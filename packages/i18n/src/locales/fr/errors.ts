...
export const errors = {
  ...
  premiumSubscriptionRequired:
    'Cette fonction nécessite Premium. Toutes les règles que vous avez définies — limites, heures de coucher, blocage d’applis, filtre web, position et SOS — restent gratuites.',
