export const plans = {
  ...
  statusTrialEndedSubtitle:
    'La Limite quotidienne, les Heures bloquées et la position continuent de fonctionner gratuitement. Abonnez-vous pour retrouver Applications bloquées, Filtre web, alertes et rapports.',
  ...
  planTrialName: 'Essai',
  planTrialMeta: 'Gratuit · {{days}} jours · Accès complet',
  ...
  sectionIncludedFeaturesSubtitle:
    'Tout ce qui suit est inclus dans l’Essai comme dans Premium.',
  footerLegal:
  ...
  featureAppAlerts: 'Alertes d’apps',
  featureUsageReports: 'Rapports d’utilisation',
  featureActivityFeed: 'Fil d’activité',
  featureParentPinProtection: 'Protection du code PIN parent',
  trialPlanName: 'Essai',
  trialDescription:
  ...
  subscribeToContinue:
    'Vous êtes maintenant sur l’offre gratuite. Abonnez-vous pour tout débloquer à nouveau.',
  ...
  memberTrialActiveSubtitle:
    'Cette famille est en période d’essai. Une fois celle-ci terminée, le propriétaire devra s’abonner pour continuer à utiliser KidGate.',
  memberTrialEndedSubtitle:
    'L’essai de cette famille est terminé. La Limite quotidienne, les Heures bloquées et la position fonctionnent toujours. Demandez au propriétaire de s’abonner pour le reste.',
  ...
  familyPremiumEndedBody:
    'La Limite quotidienne, les Heures bloquées et la position fonctionnent toujours. Applications bloquées, Filtre web, alertes et rapports sont en pause tant que le propriétaire ne renouvelle pas Premium.',
