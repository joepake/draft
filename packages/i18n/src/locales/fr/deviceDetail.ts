...
export const deviceDetail = {
  ...
  appBlockingBestEffort:
    'Sur cet appareil, une application bloquée est fermée après son ouverture, pas empêchée de s’ouvrir.',
  ...
  locationOnly: 'Localisation uniquement',
  webFilter: 'Filtre web',
  limitAdultWebsites: 'Limiter les sites inappropriés',
  ...
  adultSitesLimited: 'Sites inappropriés limités',
  blocksAdultSites: 'Limite les sites inappropriés',
  waiting: 'En attente',
  ...
  pauseBrowsingResume: 'Reprendre',
  pauseBrowsingResumeTitle: 'Reprendre la navigation ?',
  pauseBrowsingResumeBody:
    'Le web revient tout de suite et les {{minutes}} min restantes sont perdues.',
} as const;
