export const legal = {
  privacyPolicy: {
    ...
    effectiveDate: 'En vigueur à compter du 15 août 2026',
    intro:
      'KidGate est le nom commercial et de produit utilisé par le développeur indépendant qui exploite l’application. Cette politique explique comment KidGate traite les données lorsque des parents utilisent le service pour gérer l’appareil d’un enfant.',
    sections: [
      {
      ...
      },
      {
        ...
        body: 'Selon les fonctionnalités activées et les autorisations accordées, les données peuvent inclure : identifiants de compte et données de connexion Google ou Apple ; identifiants et noms d’appareils ; état d’appairage ; réglages de limites ; activité des applications et temps d’écran ; sites web demandés par l’appareil de l’enfant et ceux qui ont été filtrés ; position et historique de position ; alertes SOS, de zone, d’altération et de protection ; photos prises sur l’appareil de l’enfant lors d’un SOS ou d’un point de sécurité ; les prénoms donnés par un parent à chaque enfant, les appareils qui leur sont attribués et les totaux hebdomadaires d’étoiles du tableau des étoiles ; tâches à récompense, demandes de temps supplémentaire et rapports hebdomadaires qui résument tout cela ; diagnostics techniques, plantages, version de l’application et données de transaction d’abonnement fournies par une boutique d’applications. KidGate n’exige pas le vrai nom d’un enfant lorsqu’une fonctionnalité n’en a pas besoin.',
      },
      {
      ...
      {
        title: '4. Fondements juridiques et consentement',
      ...
      {
        title: '5. Prestataires de services et divulgation',
        body: 'Les données ne sont divulguées qu’en cas de besoin à des prestataires d’infrastructure, d’authentification, de stockage en nuage, de notification, d’analyse des plantages, de paiement ou de boutiques d’applications ; aux autorités lorsque la loi l’exige ; ou pour traiter des questions de sécurité, de fraude ou d’abus. Ces prestataires ont leurs propres obligations et politiques. Ils ne sont pas autorisés par KidGate à utiliser les données des enfants à des fins de marketing indépendant.',
      },
      {
      ...
      },
      {
        ...
        body: 'Les données sont conservées aussi longtemps que nécessaire pour fournir le service, assurer la sécurité, résoudre les litiges et respecter les obligations légales. Les parents peuvent demander la suppression du compte dans les Paramètres. Des enregistrements limités peuvent subsister lorsque la loi, la prévention de la fraude, la rotation des sauvegardes ou les transactions effectuées via une boutique d’applications l’exigent.',
      },
      {
        title: '8. Droits et choix',
        body: 'Selon le droit applicable, les utilisateurs peuvent demander l’accès, la rectification, la suppression, la limitation, l’opposition ou le retrait du consentement. Les autorisations de localisation, de notification et d’accès à l’appareil peuvent être désactivées dans le système d’exploitation, mais les fonctionnalités associées peuvent alors cesser de fonctionner ou devenir incomplètes.',
      },
      {
      ...
      {
        title: '10. Incidents de sécurité des données',
      ...
      {
        title: '11. Modifications et contact',
  ...
  termsOfService: {
    ...
    sections: [
      ...
      {
        title: '9. Disponibilité et modifications',
