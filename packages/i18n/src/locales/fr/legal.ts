  ...
  privacyPolicy: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Trois fonctionnalités utilisent les modèles Gemini de Google, accessibles via Google Cloud : le résumé rédigé du rapport hebdomadaire, généré à partir des chiffres d’utilisation propres à la famille ; le classement des applications et des domaines de sites web dans les catégories utilisées par le Filtre web et les listes d’applications, conservé dans une table partagée qui enregistre un domaine et sa catégorie, et non quelle famille l’a visité ; et l’étape de confirmation décrite à la section 3, qui ne s’exécute que si un parent y a consenti. Ces modèles produisent des appréciations qui peuvent être erronées. Une catégorie, une phrase de résumé ou une alerte de message est une invitation à regarder, pas un constat, et KidGate ne prend sur cette base aucune décision produisant un effet juridique ou comparable pour un enfant. Les sorties des modèles ne servent pas à entraîner les modèles de Google.',
      },
      {
        title: '6. Fondements juridiques et consentement',
        body: 'KidGate traite les données pour fournir les services demandés, respecter ses obligations légales, protéger des intérêts légitimes de sécurité et de sûreté, ou sur la base du consentement lorsque celui-ci est requis. Les parents sont responsables de fournir les informations requises et d’obtenir un consentement valable pour un enfant ou un utilisateur d’appareil. La surveillance des messages et la confirmation par IA font chacune l’objet d’un consentement distinct et explicite, qui peut être retiré à tout moment : la surveillance des messages s’active par appareil, et la confirmation par IA est acceptée une fois pour la famille et enregistrée avec l’identité de la personne qui l’a acceptée et la date.',
      },
      {
        title: '7. Prestataires de services',
        body: 'KidGate repose sur Google Cloud et Firebase, qui fournissent l’authentification, la base de données, le stockage de fichiers, les fonctions serveur, les notifications push via Firebase Cloud Messaging, les rapports de plantage via Firebase Crashlytics et les modèles Gemini cités à la section 5. Apple et Google traitent en outre les achats d’abonnement, les renouvellements et les remboursements via leurs boutiques d’applications, et Google Analytics traite la mesure décrite à la section 8. Quatre autres prestataires ne voient chacun qu’une seule chose : HERE Technologies convertit une position signalée en adresse et dessine les tuiles de carte derrière les écrans de localisation, et reçoit donc les coordonnées signalées par un appareil ; Resend achemine les e-mails envoyés par KidGate — une alerte SOS à un contact de confiance, et le rapport hebdomadaire ; Cloudflare distribue les programmes d’installation pour ordinateur ; et le réseau de diffusion de contenu unpkg fournit la bibliothèque cartographique aux applications parent. Les données ne sont divulguées à ces prestataires que dans la mesure nécessaire au fonctionnement du service ; aux autorités lorsque la loi l’exige ; ou pour traiter des questions de sécurité, de fraude ou d’abus. Ces prestataires ont leurs propres obligations et politiques, et aucun n’est autorisé par KidGate à utiliser les données des enfants à des fins de marketing indépendant.',
      },
      {
        title: '8. Mesure d’audience du site et cookies',
        body: 'Le site kidgate.app mesure trois choses avec Google Analytics : les visites de pages, et les clics sur chacun des deux liens de téléchargement pour ordinateur. Le stockage à des fins de mesure d’audience est refusé par défaut : aucun cookie de mesure d’audience n’est déposé et rien n’est stocké dans le navigateur du lecteur ; chaque visite est comptée à partir d’une requête sans cookie, avec l’adresse IP tronquée. Google Signals et les identifiants publicitaires sont désactivés, et rien qui identifie un lecteur ou une famille n’est envoyé. Les applications KidGate transmettent un petit ensemble d’événements à la même propriété pour indiquer quelles fonctionnalités sont utilisées ; ces événements portent un identifiant d’instance d’application — jamais l’identifiant publicitaire de l’appareil, que les applications ne collectent pas — et jamais le prénom, un message, la position ou la navigation d’un enfant. Les applications et le site n’utilisent aucun réseau publicitaire ni aucun réseau de pistage.',
      },
      {
      ...
      },
      {
        ...
        body: 'Lorsque cela est nécessaire pour répondre à une demande d’assistance ou diagnostiquer un problème, le personnel autorisé de KidGate peut ouvrir un compte familial et voir ce que voit un parent : sa configuration et ses appareils, ainsi que l’activité qu’il contient — y compris l’historique de position, l’historique web, les alertes de messages et les photos jointes à un SOS ou à un check-in. Il peut aussi modifier des réglages et envoyer des commandes aux appareils. Cet accès est limité au personnel autorisé, exige une authentification à deux facteurs et sert uniquement à l’assistance. L’ouverture d’un compte familial inscrit une ligne dans le fil d’activité de cette famille, visible par ses parents, avec l’heure et la demande d’assistance concernée ; chaque lecture des données d’une famille via les outils de l’exploitant est journalisée avec l’heure et un motif indiqué. Les actions individuelles effectuées pendant une session d’assistance ne font pas aujourd’hui l’objet d’une journalisation distincte.',
      },
      {
        title: '11. Durée de conservation des données',
        body: 'Les enregistrements expirent selon un calendrier et sont supprimés automatiquement : le Temps d’écran et l’usage par application, l’historique web, l’historique vidéo, l’historique de position et le fil d’activité au bout de 30 jours ; les alertes SOS, les check-in de sécurité et les demandes de temps supplémentaire au bout de 90 jours ; les rapports hebdomadaires au bout de 365 jours. Les codes d’appairage expirent en quelques minutes et une connexion par navigateur dure 7 jours lorsque l’application l’a accordée, ou 8 heures lorsqu’elle a été déverrouillée avec le Code PIN parent. Certains enregistrements n’ont aujourd’hui aucune date d’expiration et sont conservés jusqu’à la suppression du compte familial : le compte et ses réglages, les lieux enregistrés, les fiches des enfants et des appareils, les tâches à récompense, les demandes d’autorisation de site, le tableau des étoiles et l’historique hebdomadaire du temps d’écran, ainsi que la liste des applications installées sur chaque appareil. Les demandes d’assistance, les réponses et toute capture d’écran jointe sont supprimées 90 jours après la résolution de la demande. Une trace attestant qu’une suppression de compte a été demandée et effectuée — un hachage de l’adresse e-mail et les dates, rien d’autre — est conservée 12 mois après son exécution afin de pouvoir répondre à une contestation. Des enregistrements limités peuvent également subsister lorsque la loi, la prévention de la fraude ou les transactions effectuées via une boutique d’applications l’exigent.',
      },
      {
        title: '12. Suppression d’un compte',
        body: 'Un parent peut demander la suppression dans les Paramètres, depuis kidgate.app, ou par e-mail à support@kidgate.app depuis l’adresse associée au compte. La demande reste en attente pendant 14 jours et peut être annulée durant ce délai ; passé ce délai, le compte familial, chaque enfant et chaque appareil qui en dépendent ainsi que les fichiers stockés qui lui appartiennent sont supprimés, et la connexion elle-même est retirée. La suppression est définitive et aucun export n’est possible ensuite.',
      },
      {
        title: '13. Droits et choix',
        body: 'Selon le droit applicable, les utilisateurs peuvent demander l’accès, la rectification, la suppression, la limitation, l’opposition ou le retrait du consentement. Ces demandes, y compris celles visant à obtenir une copie des données détenues sur une famille, s’adressent à support@kidgate.app ; il n’existe pas aujourd’hui d’export en libre-service. La surveillance des messages et la confirmation par IA peuvent être désactivées à tout moment sans que le reste du service en soit affecté. Les autorisations de localisation, de notification, d’appareil photo et d’accès à l’appareil peuvent être désactivées dans le système d’exploitation, mais les fonctionnalités qui en dépendent cesseront de fonctionner ou deviendront incomplètes, et KidGate le signale sur l’écran du parent au lieu d’afficher une commande qui ne fonctionne plus.',
      },
      {
      ...
      },
      {
        ...
        body: 'Cette politique peut évoluer avec les fonctionnalités ou la législation. Les mises à jour importantes seront communiquées dans l’application ou par un canal de diffusion approprié. Les demandes et questions relatives à la confidentialité s’adressent à support@kidgate.app, l’adresse également publiée sur les fiches KidGate des boutiques d’applications.',
      },
    ],
  },
  termsOfService: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Un essai gratuit avec accès complet commence dès l’appairage de vos premiers appareils parent et enfant et dure la période indiquée dans l’application. À la fin, les règles que vous avez définies continuent de s’appliquer sans paiement sur un appareil enfant — Limite quotidienne, Heures bloquées, Applications bloquées, limites par application, le Filtre web, la recherche sécurisée, le Verrouillage de l’appareil, les demandes de temps supplémentaire, les tâches à récompense et la surveillance des messages — et un parent peut encore demander à cet appareil sa position actuelle un nombre limité de fois par jour. Le SOS n’est jamais soumis à paiement. L’activité en direct, l’historique, les rapports hebdomadaires, le suivi de position, les adresses et les alertes de lieux deviennent des fonctions Premium. Lorsqu’une famille compte plus d’appareils enfants que la formule n’en couvre, les appareils supplémentaires sont mis en pause : ils continuent d’appliquer les règles déjà définies, ces règles peuvent être assouplies mais pas durcies, et ils cessent d’envoyer de l’activité. C’est vous qui choisissez l’appareil qui reste surveillé, et ce choix peut être modifié une fois tous les sept jours. Retirer un appareil enfant ne relance pas l’essai. Une famille ne peut appairer qu’un nombre limité d’appareils enfants sur la durée de vie du compte ; ce nombre dépend de la formule, l’application l’indique lorsqu’il est atteint, et un appareil retiré compte toujours dans ce total.',
      },
      {
        title: '8. Abonnements et paiements',
        body: 'Les achats, renouvellements, annulations et remboursements sont régis par les conditions de l’App Store d’Apple ou de Google Play, et un abonnement ne peut être acheté ou restauré que depuis l’application KidGate pour iPhone, iPad ou Android — une famille dont tous les appareils sont des ordinateurs, des téléviseurs ou des Chromebooks a besoin de l’un d’eux pour payer. Un seul abonnement couvre toute la famille et seul le titulaire de la famille peut l’acheter ou le restaurer ; un achat tenté depuis le compte d’un autre parent est refusé. Les formules mensuelle et annuelle se renouvellent automatiquement sauf annulation via la boutique au moins 24 heures avant la fin de la période. L’achat unique ne se renouvelle pas, couvre le nombre d’appareils enfants indiqué dans l’application et vaut tant que KidGate est proposé ; la section 12 précise ce qui se passe si cela cesse. Les prix et fonctionnalités des formules peuvent changer après notification requise par la loi et les règles des boutiques d’applications.',
      },
      {
      ...
      },
      {
        ...
        body: 'Vous pouvez cesser d’utiliser le service et demander la suppression du compte. La suppression reste en attente pendant 14 jours et peut être annulée durant ce délai ; passé ce délai, le compte familial et ses données sont définitivement supprimés. KidGate peut suspendre ou résilier le service en cas de violation, de risque pour la sécurité ou d’exigence légale. Les parties doivent d’abord tenter de bonne foi de résoudre les litiges, en commençant par un e-mail à support@kidgate.app. Les présentes conditions sont régies par le droit du Vietnam et les litiges relèvent des tribunaux compétents du Vietnam, sauf lorsque les règles impératives de protection des consommateurs du pays où vous résidez vous permettent de vous prévaloir d’une autre loi ou d’une autre juridiction.',
      },
      {
