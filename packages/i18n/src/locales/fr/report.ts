export const report = {
  ...
  findingLateNight_one:
    'Une nuit après 23 h : l’écran est resté allumé jusqu’à {{time}}.',
  ...
  currentWeekBody: 'Le rapport de cette semaine arrive {{day}}.',
  currentWeekNote:
    'Il couvre du lundi au dimanche, sur tous les appareils de la famille. Rien ne manque encore — la semaine n’est pas terminée.',

  emptyTitle: 'Pas encore de rapport',
  emptyBody:
    'Un rapport arrive chaque lundi matin. Vous pouvez aussi rédiger celui de cette semaine maintenant : il couvre les sept derniers jours.',
  noUsage:
  ...
  hubChildUnassigned: 'Aucun appareil assigné',
  ...
  guestDescription:
    'Connectez-vous pour mesurer aujourd’hui face à une journée normale, comparer vos enfants côte à côte et recevoir un rapport chaque lundi.',
  ...
  guestBenefitWeeklyTitle: 'Un rapport chaque lundi',
