export const pairing = {
  ...
  shareInviteMessage:
    'Rejoignez notre famille sur KidGate : ouvrez l’application, allez dans Famille → Scanner un code, puis scannez le code QR ou saisissez le code {{code}}. Le code expire dans 15 minutes.',
