export const plans = {
  ...
  statusTrialEndedSubtitle:
    'Tageslimit, Sperrzeiten und Standort laufen kostenlos weiter. Abonniere, um Blockierte Apps, Webfilter, Warnungen und Berichte zurückzubekommen.',
  ...
  planTrialMeta: 'Kostenlos · {{days}} Tage · Voller Zugriff',
  ...
  sectionIncludedFeaturesSubtitle:
    'Alles unten ist sowohl in der Testphase als auch in Premium enthalten.',
  footerLegal:
  ...
  featureAppAlerts: 'App-Warnungen',
  featureUsageReports: 'Nutzungsberichte',
  featureActivityFeed: 'Aktivitätsverlauf',
  featureParentPinProtection: 'Eltern-PIN-Schutz',
