export const deviceDetail = {
  ...
  activeNowLocked: 'Sperrzeiten aktiv · gesperrt',
  ...
  waitingForChild: 'Warten auf das Kind',
  ...
  rewardTasksEarnable: 'Heute {{minutes}} Bonusminuten zu verdienen',
  rewardTasksEmptyDetail: 'Lass dein Kind extra Bildschirmzeit verdienen',
  rewardTasksWaitingReview: 'Warten auf deine Prüfung: {{count}}',
  ...
  pauseBrowsingResumeTitle: 'Surfen fortsetzen?',
  pauseBrowsingResumeBody:
    'Das Web ist sofort wieder da, die restlichen {{minutes}} Min. verfallen.',
} as const;
