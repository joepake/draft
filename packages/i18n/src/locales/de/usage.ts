export const usage = {
  ...
  limitOff: 'Aus',
  sectionStatusNow: 'Aktueller Status',
  ...
  chartNoDataYet:
    'Die Balken füllen sich, sobald das Kindergerät die tägliche Nutzung synchronisiert. Der heutige Balken aktualisiert sich anhand der Live-Minuten.',
