export const legal = {
  privacyPolicy: {
    ...
    effectiveDate: 'Gültig ab 15. August 2026',
    intro:
      'KidGate ist der Produkt- und Handelsname, den der unabhängige Entwickler verwendet, der die App betreibt. Diese Richtlinie erläutert, wie KidGate mit Daten umgeht, wenn Eltern den Dienst nutzen, um das Gerät eines Kindes zu verwalten.',
    sections: [
      {
      ...
      },
      {
        ...
        body: 'Je nach aktivierten Funktionen und Berechtigungen können Daten umfassen: Kontokennungen und Google- oder Apple-Anmeldedaten; Gerätekennungen und -namen; Kopplungsstatus; Limit-Einstellungen; App-Aktivität und Bildschirmzeit; Websites, die ein Kindergerät angefragt hat, und welche davon gefiltert wurden; Standort und Standortverlauf; SOS-, Geofence-, Manipulations- und Schutzhinweise; Fotos, die auf dem Kindergerät bei einem SOS oder einem Sicherheits-Check-in aufgenommen werden; die Namen, die ein Elternteil den Kindern gibt, die ihnen zugeordneten Geräte und die Wochensummen der Sterne auf der Sternetafel; Belohnungsaufgaben, Anfragen nach zusätzlicher Zeit und die Wochenberichte, die all das zusammenfassen; technische Diagnosen, Abstürze, App-Version und Abo-Transaktionsdaten aus einem App-Store. KidGate verlangt den echten Namen eines Kindes nicht, wenn eine Funktion ihn nicht braucht.',
      },
      {
        title: '3. Wie Daten verwendet werden',
        body: 'Daten unterstützen Authentifizierung, Gerätekopplung, elterliche Kontrollen, Einstellungssynchronisierung, Warnungen, Berichte, Abonnements, Betrugsprävention, Kontosicherheit, Fehlerbehebung und Zuverlässigkeit. KidGate verkauft keine personenbezogenen Daten und verwendet keine Daten von Kindern für verhaltensbasierte Werbung.',
      },
      {
        title: '4. Rechtsgrundlagen und Einwilligung',
        body: 'KidGate verarbeitet Daten, um angeforderte Dienste bereitzustellen, gesetzlichen Pflichten nachzukommen, berechtigte Sicherheitsinteressen zu schützen oder, sofern erforderlich, auf Grundlage einer Einwilligung. Eltern sind dafür verantwortlich, erforderliche Hinweise zu erteilen und eine gültige Einwilligung für ein Kind oder einen Gerätenutzer einzuholen.',
      },
      {
        title: '5. Dienstleister und Offenlegung',
        body: 'Daten werden nur offengelegt, soweit dies erforderlich ist, gegenüber Infrastruktur-, Authentifizierungs-, Cloud-Speicher-, Benachrichtigungs-, Absturzanalyse-, Zahlungs- oder App-Store-Anbietern; gegenüber Behörden, sofern gesetzlich vorgeschrieben; oder um Sicherheits-, Betrugs- oder Missbrauchsfragen zu adressieren. Anbieter unterliegen eigenen Pflichten und Richtlinien. Sie sind von KidGate nicht autorisiert, Daten von Kindern für eigenständiges Marketing zu verwenden.',
      },
      {
      ...
      },
      {
        ...
        body: 'Daten werden so lange aufbewahrt, wie es zur Bereitstellung des Dienstes, zur Aufrechterhaltung der Sicherheit, zur Beilegung von Streitigkeiten und zur Erfüllung gesetzlicher Pflichten erforderlich ist. Eltern können die Löschung des Kontos in den Einstellungen beantragen. Begrenzte Aufzeichnungen können verbleiben, soweit dies gesetzlich vorgeschrieben ist oder zur Betrugsprävention, für rotierende Sicherungskopien oder für App-Store-Transaktionen erforderlich ist.',
      },
      {
        title: '8. Rechte und Wahlmöglichkeiten',
        body: 'Je nach anwendbarem Recht können Nutzer Zugang, Berichtigung, Löschung, Einschränkung, Widerspruch oder Widerruf der Einwilligung verlangen. Standort-, Benachrichtigungs- und Geräteberechtigungen können im Betriebssystem deaktiviert werden, wobei die betreffenden Funktionen dann möglicherweise nicht mehr oder nur eingeschränkt funktionieren.',
      },
      {
        title: '9. Daten von Kindern',
      ...
      {
        title: '11. Änderungen und Kontakt',
  ...
  termsOfService: {
    ...
    sections: [
      ...
      {
        title: '2. Zweck des Dienstes',
        body: 'KidGate stellt Werkzeuge bereit, die Eltern helfen, Geräte zu verwalten, Grenzwerte festzulegen, den Status einzusehen und Warnungen zu erhalten. Er ersetzt keine direkte Aufsicht, medizinische Beratung, Notfalldienste, Strafverfolgungsbehörden oder professionelle Kinderschutzdienste.',
      },
      {
        title: '3. Pflichten der Eltern',
        body: 'Sie müssen Kindern einen angemessenen Hinweis geben, die erforderliche Einwilligung einholen, Berechtigungen korrekt konfigurieren, Funktionen testen und Datenschutz-, Überwachungs-, Arbeits-, Bildungs- und Kinderschutzgesetze einhalten. Verwenden Sie KidGate nicht für verdeckte Überwachung, Belästigung, rechtswidrige Kontrolle oder die Verletzung der Rechte einer anderen Person.',
      },
      {
        title: '4. Kontosicherheit',
        body: 'Sie sind verantwortlich für die Kontoaktivität und für den Schutz von Geräten, PINs und Anmeldeverfahren. Melden Sie vermuteten unbefugten Zugriff umgehend. KidGate kann Konten oder Geräte vorübergehend einschränken, um Nutzer zu schützen oder Missbrauch zu untersuchen.',
      },
      {
        title: '5. Plattformberechtigungen und technische Einschränkungen',
        body: 'Funktionen hängen von Betriebssystemberechtigungen, Netzwerkzugang, Akkustatus, Herstellereinstellungen, Standortdiensten und Plattformen Dritter ab. Warnungen können verzögert, unvollständig oder ungenau sein. Sie müssen Geräte direkt überprüfen und dürfen sich für Sicherheit oder Notfälle nicht ausschließlich auf KidGate verlassen.',
      },
      {
        title: '6. Abonnements und Zahlungen',
        body: 'Käufe, Verlängerungen, Kündigungen und Rückerstattungen werden gemäß den Bedingungen des Apple App Store, Google Play oder des jeweiligen Zahlungsanbieters abgewickelt. Preise und Funktionen der Pläne können sich nach der gesetzlich vorgeschriebenen und den Store-Regeln entsprechenden Ankündigung ändern.',
      },
      {
        title: '7. Lizenz und Eigentum',
      ...
      {
        title: '13. Beendigung und Streitigkeiten',
        body: 'Sie können die Nutzung des Dienstes beenden und die Löschung des Kontos beantragen. KidGate kann den Dienst wegen Verstößen, Sicherheitsrisiken oder rechtlicher Anforderungen aussetzen oder beenden. Die Parteien sollen zunächst nach Treu und Glauben versuchen, Streitigkeiten beizulegen; das anwendbare Recht und die zuständigen Gerichte richten sich nach den für den Nutzer und den Betreiber geltenden zwingenden Vorschriften.',
      },
      {
      ...
      {
        title: '15. Software von Drittanbietern',
