export const protection = {
  ...
  locationConsentPending:
    'Геопозиция не разрешена на этом устройстве, поэтому оно не может сообщить, где находится.',
  consentStepOpenSettings:
    'Откройте KidGate на устройстве ребёнка и перейдите в настройки.',
  consentStepParentPin: 'Введите родительский PIN-код.',
  consentStepPermissions: 'Откройте «Разрешения» и разрешите то, чего не хватает.',
  ...
  scheduleNote:
    'До 3 интервалов Заблокированных часов блокируют приложения через Экранное время.',
