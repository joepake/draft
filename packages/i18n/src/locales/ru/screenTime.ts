export const screenTime = {
  ...
  screenTimeNeededForControls:
    'Для блокировки приложений, Заблокированных часов и блокировки устройства нужно Экранное время на этом устройстве.',
  screenTimeNeededForLimits:
    'Без Экранного времени блокировка, Заблокированные часы и лимиты приложений не работают.',
