...
export const report = {
  ...
  weekOf: 'Неделя {{week}}',
  range: '{{from}} – {{to}}',
  triggerScheduled: 'Отправлен в понедельник',
  ...
  findingQuietWeek:
    'Спокойная неделя — всего {{total}}, и ничего, что потребовало бы вашего внимания.',
  ...
  currentWeekBody: 'Отчёт за эту неделю придёт в {{day}}.',
  currentWeekNote:
    'Он охватывает период с понедельника по воскресенье на всех устройствах семьи. Пока ничего не пропущено — неделя ещё не закончилась.',

  emptyTitle: 'Отчёта пока нет',
  emptyBody:
    'Отчёт приходит каждый понедельник утром. Можно составить отчёт за эту неделю прямо сейчас — он охватывает последние семь дней.',
  noUsage:
  ...
  hubChildUnassigned: 'Устройство не назначено',
  ...
  guestDescription:
    'Войдите, чтобы сравнить сегодня с обычным днём, поставить детей рядом друг с другом и получать отчёт каждый понедельник.',
  ...
  guestBenefitWeeklyTitle: 'Отчёт каждый понедельник',
