export const family = {
  ...
  parkReviewBody:
    'ट्रायल ख़त्म होने पर एक डिवाइस रिपोर्ट भेजता रहेगा और उसी के नियम बदले जा सकेंगे, बाकी अपने मौजूदा नियम बनाए रखेंगे। उन पर बाद में नियमों में सिर्फ़ ढील दी जा सकेगी, इसलिए जो अभी बंद है वह बंद ही रहेगा।',
  rulesEnforcedOn: '{{total}} में से {{enforced}} डिवाइस पर लागू',
  rulesPausedBehind: 'रुका हुआ — अब भी पुरानी सेटिंग पर',
  rulesTightenRefused:
    'रुके हुए डिवाइस पर नियमों में सिर्फ़ ढील दी जा सकती है, उन्हें सख़्त कभी नहीं किया जा सकता। हर डिवाइस पर बदलने के लिए अपग्रेड करें।',
  ...
  chooseMonitoredBody:
    'सभी डिवाइस पर सभी नियम चलते रहेंगे। आपका चुना हुआ डिवाइस स्क्रीन टाइम और लोकेशन भेजता है, और नियम सिर्फ़ उसी पर सख़्त किए जा सकते हैं — बाकी डिवाइस पर नियमों में सिर्फ़ ढील दी जा सकती है। अपना चुनाव आप हर {{days}} दिन में एक बार बदल सकते हैं।',
  ...
  freeTierCadenceHint: 'फ़्री प्लान — अंतिम गतिविधि: {{date}}',
