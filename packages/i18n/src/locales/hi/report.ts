export const report = {
  ...
  findingLimitHit: '{{limit}} की दैनिक सीमा {{count}} दिन पूरी हुई।',
  findingBlockedApps:
  ...
  findingBlockedAppsDown:
    '{{count}} बार ब्लॉक किए गए ऐप खोलने की कोशिश हुई, पिछले हफ़्ते {{previous}} थीं।',
  ...
  currentWeekBody: 'इस हफ़्ते की रिपोर्ट {{day}} को आएगी।',
  currentWeekNote:
    'यह सोमवार से रविवार तक, परिवार के हर डिवाइस को कवर करती है। अभी कुछ छूटा नहीं है — हफ़्ता ख़त्म नहीं हुआ।',

  emptyTitle: 'अभी कोई रिपोर्ट नहीं',
  emptyBody:
    'हर सोमवार सुबह एक रिपोर्ट आती है। आप इस हफ़्ते की अभी भी लिख सकते हैं — इसमें पिछले सात दिन आते हैं।',
  noUsage:
  ...
  historyTitle: 'पिछले हफ़्तों की रिपोर्ट',
  ...
  hubChildUnassigned: 'कोई डिवाइस असाइन नहीं',
  ...
  busiest: 'सबसे ज़्यादा स्क्रीन टाइम',
  ...
  guestDescription:
    'साइन इन करें और आज की तुलना एक सामान्य दिन से करें, बच्चों को साथ-साथ देखें, और हर सोमवार एक रिपोर्ट पाएँ।',
  ...
  guestBenefitWeeklyTitle: 'हर सोमवार एक रिपोर्ट',
