export const screenTime = {
  ...
  screenTimeDeniedStepReturnWhenReady:
    'यहाँ लौटें — सेटअप पूरा होते ही यह कार्ड गायब हो जाएगा।',
  screenTimeSetupStep1: 'नीचे ऐप और वेबसाइट उपयोग की अनुमति दें चुनें।',
  screenTimeSetupStep2: 'पूछे जाने पर ऐप और वेबसाइट उपयोग डायलॉग में अनुमति दें चुनें।',
  screenTimeSetupStep3: 'डायलॉग बंद होने के बाद यहाँ लौटें।',
  screenTimeDeniedStep1: 'नीचे ऐप सेटिंग्स खोलें चुनें।',
  screenTimeDeniedStep2: '{{appName}} पेज पर स्क्रीन टाइम चालू करें।',
  screenTimeDeniedStep3: '{{appName}} पर लौटें — यह कार्ड गायब हो जाएगा।',
  screenTimeBannerTitleDenied: 'स्क्रीन टाइम चालू करें',
  screenTimeBannerTitleRequest: 'ऐप और वेबसाइट उपयोग की अनुमति दें',
  ...
  usageAccessStepOpenSettings: 'नीचे सेटिंग्स खोलें चुनें।',
  usageAccessStepFindKidGate: 'KidGate ढूँढें और उपयोग की पहुँच चालू करें।',
  usageAccessStepReturn: 'यहाँ लौटें — स्थिति अपने आप अपडेट हो जाती है।',
  noDailyLimitSet: 'दैनिक सीमा सेट नहीं है',
  limitReachedStatus: '{{used}} / {{limit}} · सीमा पूरी हुई',
