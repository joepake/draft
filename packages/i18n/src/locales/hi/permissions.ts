export const permissions = {
  ...
  oemAutostartHintHuawei:
    'ऐप लॉन्च / स्टार्टअप मैनेजर में, KidGate को मैन्युअली प्रबंधित करें पर सेट करें और सभी विकल्पों की अनुमति दें।',
  ...
  accessibilityStepOpenSettings:
    'नीचे सेटिंग्स चुनें — इससे सीधे KidGate का एक्सेसिबिलिटी पेज खुलता है।',
