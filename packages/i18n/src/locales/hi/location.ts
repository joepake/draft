export const location = {
  ...
  locationBannerBodySharingOff:
    'स्थान साझा करना अभी बंद है, इसलिए कुछ भी नहीं भेजा जा रहा। यहाँ अनुमति दे देंगे तो आगे चलकर आपके माता-पिता इसे चालू करेंगे और यह तुरंत काम करने लगेगा।',
  ...
  requestIpOnly:
    'यह डिवाइस केवल इंटरनेट कनेक्शन से अपने स्थान का अनुमान लगा सका। डिवाइस पर Wi-Fi चालू करें (कनेक्ट करने की ज़रूरत नहीं) और फिर से कोशिश करें।',
  cardSharingOff: 'स्थान साझाकरण बंद है',
  cardPermissionOff: 'इस डिवाइस पर स्थान की अनुमति नहीं है',
  cardIpOnly:
    'इस डिवाइस का स्थान पता नहीं चल पा रहा है: डिवाइस पर Wi-Fi चालू करें (कनेक्ट करने की ज़रूरत नहीं)',
