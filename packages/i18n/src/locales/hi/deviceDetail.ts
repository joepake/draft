...
export const deviceDetail = {
  ...
  appBlockingBestEffort:
    'इस डिवाइस पर ब्लॉक किया गया ऐप खुलने के बाद बंद किया जाता है, खुलने से नहीं रोका जाता।',
  ...
  noBlockedHours: 'कोई ब्लॉक किया गया समय सेट नहीं',
  ...
  activeNowLocked: 'ब्लॉक किए गए समय सक्रिय · लॉक',
  editHours: 'समय बदलें',
  setHours: 'सेट करें',
  items: 'चयनित',
  ...
  adultSitesLimited: 'अनुपयुक्त वेबसाइटें सीमित हैं',
  blocksAdultSites: 'अनुपयुक्त साइटों को सीमित करता है',
