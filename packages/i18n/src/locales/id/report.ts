export const report = {
  ...
  finePrint:
    'Angka mencakup {{from}} sampai {{to}}, dari semua perangkat dalam keluarga. Waktu layar adalah angka yang dilaporkan perangkat; menit yang tidak dapat diukur perangkat tidak masuk ke total mana pun.',
  ...
  currentWeekBody: 'Laporan minggu ini tiba {{day}}.',
  currentWeekNote:
    'Laporan mencakup Senin sampai Minggu, di semua perangkat keluarga. Belum ada yang terlewat — minggunya belum selesai.',

  emptyTitle: 'Belum ada laporan',
  emptyBody:
    'Laporan datang setiap Senin pagi. Anda juga bisa menulis laporan minggu ini sekarang — mencakup tujuh hari terakhir.',
  noUsage:
  ...
  hubByChild: 'Per anak',
  hubChildUnassigned: 'Tidak ada perangkat yang ditetapkan',
  ...
  guestTitle: 'Lihat minggu ini dihabiskan untuk apa',
  guestDescription:
    'Masuk untuk membandingkan hari ini dengan hari biasa, melihat angka tiap anak berdampingan, dan menerima laporan setiap Senin.',
  ...
  guestBenefitWeeklyTitle: 'Laporan setiap Senin',
