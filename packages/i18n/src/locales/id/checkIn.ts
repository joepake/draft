export const checkIn = {
  ...
  checkInRequestedDescription:
    'Meminta {{deviceName}} mengonfirmasi bahwa dia aman, dengan lokasi dan foto.',
  checkInRequestedDescriptionLocation:
    'Meminta {{deviceName}} mengonfirmasi bahwa dia aman, dengan lokasi.',
  checkInConfirmed: 'Check-In dikonfirmasi',
  checkInConfirmedDescription: '{{deviceName}} mengonfirmasi bahwa dia aman.',
  ...
  showAllDevices: 'Tampilkan semua {{count}} perangkat',
  showFewerDevices: 'Tampilkan lebih sedikit perangkat',
