export const legal = {
  privacyPolicy: {
    ...
    effectiveDate: 'Berlaku mulai 15 Agustus 2026',
    intro:
      'KidGate adalah nama produk dan nama dagang yang digunakan oleh pengembang independen yang mengoperasikan aplikasi ini. Kebijakan ini menjelaskan bagaimana KidGate menangani data ketika orang tua menggunakan layanan untuk mengelola perangkat anak.',
    sections: [
      {
      ...
      {
        title: '2. Data yang dapat kami proses',
        body: 'Bergantung pada fitur yang diaktifkan dan izin yang diberikan, data dapat mencakup pengenal akun dan data masuk Google atau Apple; pengenal dan nama perangkat; status penyambungan; pengaturan batas; aktivitas aplikasi dan waktu layar; situs web yang diminta perangkat anak dan mana saja yang difilter; lokasi dan riwayat lokasi; peringatan SOS, area, gangguan, dan perlindungan; foto yang diambil di perangkat anak saat SOS atau Check-In dikirim; nama yang diberikan orang tua untuk tiap anak, perangkat yang ditugaskan kepada mereka, dan total bintang mingguan di papan bintang; tugas berhadiah, permintaan waktu tambahan, dan laporan mingguan yang merangkum semua itu; diagnostik teknis, laporan kerusakan, versi aplikasi, dan data transaksi langganan yang disediakan toko aplikasi. KidGate tidak mewajibkan nama asli anak jika sebuah fitur tidak membutuhkannya.',
      },
      {
        title: '3. Cara data digunakan',
        body: 'Data mendukung autentikasi, pemasangan perangkat, kontrol orang tua, sinkronisasi pengaturan, peringatan, laporan, langganan, pencegahan penipuan, keamanan akun, penyelesaian masalah, dan keandalan layanan. KidGate tidak menjual data pribadi dan tidak menggunakan data anak untuk iklan berbasis perilaku.',
      },
      {
        title: '4. Dasar hukum dan persetujuan',
        body: 'KidGate memproses data untuk menyediakan layanan yang diminta, memenuhi kewajiban hukum, melindungi kepentingan keamanan dan keselamatan yang sah, atau berdasarkan persetujuan apabila diperlukan. Orang tua bertanggung jawab memberikan pemberitahuan yang diperlukan dan memperoleh persetujuan yang sah untuk anak atau pengguna perangkat.',
      },
      {
        title: '5. Penyedia layanan dan pengungkapan',
        body: 'Data hanya diungkapkan sesuai kebutuhan kepada penyedia infrastruktur, autentikasi, penyimpanan cloud, notifikasi, analitik crash, pembayaran, atau toko aplikasi; kepada pihak berwenang apabila diwajibkan secara hukum; atau untuk menangani masalah keamanan, penipuan, atau penyalahgunaan. Para penyedia memiliki kewajiban dan kebijakan mereka sendiri. Mereka tidak diberi wewenang oleh KidGate untuk menggunakan data anak demi pemasaran independen.',
      },
      {
      ...
      },
      {
        ...
        body: 'Data disimpan sesuai kebutuhan untuk menyediakan layanan, menjaga keamanan, menyelesaikan sengketa, dan memenuhi kewajiban hukum. Orang tua dapat mengajukan permintaan penghapusan akun di Pengaturan. Catatan terbatas dapat tetap disimpan apabila diwajibkan oleh hukum, pencegahan penipuan, rotasi cadangan data, atau transaksi toko aplikasi.',
      },
      {
        title: '8. Hak dan pilihan',
        body: 'Bergantung pada hukum yang berlaku, pengguna dapat mengajukan permintaan akses, koreksi, penghapusan, pembatasan, keberatan, atau penarikan persetujuan. Izin lokasi, notifikasi, dan perangkat dapat dinonaktifkan melalui sistem operasi, namun fitur terkait dapat berhenti berfungsi atau menjadi tidak lengkap.',
      },
      {
        title: '9. Data anak',
  ...
  termsOfService: {
    ...
    sections: [
      ...
      {
        title: '2. Tujuan layanan',
        body: 'KidGate menyediakan alat yang membantu orang tua mengelola perangkat, menetapkan batasan, melihat status, dan menerima peringatan. Layanan ini tidak menggantikan pengawasan langsung, nasihat medis, layanan darurat, penegakan hukum, atau layanan perlindungan anak profesional.',
      },
      {
        title: '3. Tanggung jawab orang tua',
        body: 'Anda wajib memberikan pemberitahuan yang sesuai kepada anak, memperoleh persetujuan yang diperlukan, mengonfigurasi izin dengan benar, menguji fitur, serta mematuhi hukum privasi, pemantauan, ketenagakerjaan, pendidikan, dan perlindungan anak. Jangan gunakan KidGate untuk pemantauan diam-diam, pelecehan, kontrol yang melanggar hukum, atau pelanggaran hak orang lain.',
      },
      {
        title: '4. Keamanan akun',
        body: 'Anda bertanggung jawab atas aktivitas akun serta perlindungan perangkat, PIN, dan metode masuk. Segera laporkan dugaan akses tanpa izin. KidGate dapat membatasi akun atau perangkat sementara untuk melindungi pengguna atau menyelidiki penyalahgunaan.',
      },
      {
        title: '5. Izin platform dan batasan teknis',
        body: 'Fitur bergantung pada izin sistem operasi, akses jaringan, kondisi baterai, pengaturan pabrikan, layanan lokasi, dan platform pihak ketiga. Peringatan dapat tertunda, tidak lengkap, atau tidak akurat. Anda harus memeriksa perangkat secara langsung dan tidak boleh hanya mengandalkan KidGate untuk keselamatan atau keadaan darurat.',
      },
      {
        title: '6. Langganan dan pembayaran',
        body: 'Pembelian, perpanjangan, pembatalan, dan pengembalian dana ditangani sesuai ketentuan Apple App Store, Google Play, atau penyedia pembayaran terkait. Harga dan fitur paket dapat berubah setelah pemberitahuan yang diwajibkan oleh hukum dan aturan toko aplikasi.',
      },
      {
        title: '7. Lisensi dan kepemilikan',
      ...
      {
        title: '8. Perilaku yang dilarang',
      ...
      {
        title: '9. Ketersediaan dan perubahan',
      ...
      {
        title: '15. Perangkat lunak pihak ketiga',
