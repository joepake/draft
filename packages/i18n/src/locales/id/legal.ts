  ...
  privacyPolicy: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Apa yang diproses KidGate bergantung pada fitur yang diaktifkan orang tua dan izin yang diberikan sistem operasi. Data itu dapat mencakup: pengenal akun serta metode masuk Google, Apple, atau email yang dipakai membuat akun orang tua; nama yang diberikan orang tua untuk tiap anak dan perangkat yang ditugaskan kepada mereka; nama perangkat, model, jenis perangkat, versi sistem operasi dan versi aplikasi, tingkat baterai, serta status penyambungan; pengaturannya sendiri — Batas harian, Jam Diblokir, Aplikasi yang Diblokir, batas per aplikasi, kategori Filter web, dan PIN Orang Tua, yang hanya disimpan sebagai hash satu arah; total Waktu Layar, rinciannya per aplikasi, dan catatan per menit tentang kapan perangkat digunakan; aplikasi yang terpasang di perangkat dan ekstensi browser yang ditambahkan padanya; domain yang diminta perangkat anak dan mana saja yang ditolak Filter web, dihitung per hari dan per jam; judul dan nama kanal video yang diputar jika platformnya menampilkan keduanya; lokasi, riwayat lokasi, tempat yang disimpan orang tua, dan peringatan saat perangkat tiba di atau meninggalkan salah satunya; peringatan SOS, Check-In keselamatan, dan foto yang dikirim anak bersama salah satunya; nama dan alamat email kontak tepercaya mana pun yang ditambahkan orang tua, agar KidGate dapat mengirimi mereka email pada setiap SOS; peringatan yang muncul saat sebuah perlindungan dimatikan, saat sebuah aplikasi dipasang, saat penggunaan tampak tidak biasa — aplikasi baru, atau penggunaan selama Jam Diblokir — atau saat sebuah pesan atau pencarian cocok dengan daftar kata kunci yang diaktifkan orang tua; permintaan waktu tambahan, permintaan pembukaan situs, tugas hadiah, dan total bintang mingguan yang ditampilkan di papan bintang; laporan mingguan yang merangkum semua itu; pesan dukungan dan tangkapan layar apa pun yang dilampirkan padanya; laporan kerusakan dan diagnostik teknis; serta data transaksi langganan yang disediakan toko aplikasi. KidGate tidak meminta nama asli anak jika sebuah fitur tidak membutuhkannya.',
      },
      {
        title: '3. Yang tetap berada di perangkat anak',
        body: 'Pemantauan pesan dan pencarian berjalan di perangkat itu sendiri, hanya di Android, dan hanya ketika orang tua mengaktifkannya. Perangkat membandingkan teks dengan daftar kata kunci yang tersimpan secara lokal; yang dikirim adalah peringatan yang menyebutkan kata atau frasa pendek yang cocok, kategorinya, aplikasi tempat kata itu muncul, dan waktunya. Isi pesannya sendiri, sisa percakapan, dan dengan siapa percakapan itu terjadi tidak dikirim dan tidak disimpan oleh KidGate. Ada satu pengecualian, dan itu merupakan persetujuan tersendiri: jika orang tua juga menyetujui konfirmasi AI, pesan masuk yang kecocokan kata kuncinya ambigu dikirim ke model Gemini milik Google untuk dinilai, dengan alamat email, nomor telepon, dan alamat web disamarkan lebih dulu, sehingga orang tua tidak diberi peringatan karena sebuah kata biasa. Hanya hasil penilaiannya yang disimpan; pesan itu dibuang begitu selesai dinilai. Teks yang ditulis anak tidak pernah dikirim untuk konfirmasi AI, apa pun yang telah disetujui keluarga. Di luar jalur itu, KidGate mencatat domain yang diminta perangkat dan apakah domain itu ditolak — bukan alamat sebuah halaman atau isinya — dan berkas, foto, serta penjelajahan yang tidak dibaca oleh fitur aktif mana pun tetap berada di perangkat.',
      },
      {
      ...
      },
      {
        ...
        body: 'Jika diperlukan untuk menjawab permintaan dukungan atau mendiagnosis gangguan, personel KidGate yang berwenang dapat membuka sebuah akun keluarga dan melihat apa yang dilihat orang tua: konfigurasi dan perangkatnya, serta aktivitas di dalamnya — termasuk riwayat lokasi, riwayat web, peringatan pesan, dan foto yang dilampirkan pada SOS atau Check-In. Mereka juga dapat mengubah pengaturan dan mengirim perintah ke perangkat. Akses ini terbatas pada personel yang berwenang, memerlukan autentikasi dua faktor, dan digunakan semata-mata untuk keperluan dukungan. Membuka sebuah akun keluarga menuliskan satu baris ke umpan aktivitas keluarga itu sendiri, yang dapat dilihat orang tuanya, beserta waktu dan tiket dukungan yang terkait; setiap pembacaan catatan sebuah keluarga melalui perkakas operator dicatat beserta waktu dan alasan yang dinyatakan. Tindakan satu per satu di dalam sesi dukungan saat ini belum dicatat secara terpisah.',
      },
      {
        title: '11. Berapa lama data disimpan',
        body: 'Catatan kedaluwarsa menurut jadwal dan dihapus otomatis: Waktu Layar dan penggunaan per aplikasi, riwayat web, riwayat video, riwayat lokasi, dan umpan aktivitas setelah 30 hari; peringatan SOS, Check-In keselamatan, dan permintaan waktu tambahan setelah 90 hari; laporan mingguan setelah 365 hari. Kode penyambungan kedaluwarsa dalam hitungan menit dan sesi masuk lewat browser bertahan 7 hari bila diberikan lewat aplikasi, atau 8 jam bila dibuka dengan PIN Orang Tua. Sebagian catatan saat ini belum memiliki masa kedaluwarsa dan disimpan sampai akun keluarga dihapus: akun beserta pengaturannya, tempat tersimpan, catatan anak dan perangkat, tugas hadiah, permintaan pembukaan situs, papan bintang dan papan waktu layar, serta daftar aplikasi. Permintaan dukungan, balasan, dan tangkapan layar yang dilampirkan dihapus 90 hari setelah permintaan diselesaikan. Catatan bahwa penghapusan akun pernah diminta dan diselesaikan — hash alamat email dan tanggalnya, tidak ada yang lain — disimpan selama 12 bulan setelah selesai agar penghapusan yang dipersengketakan dapat dijawab. Catatan terbatas juga dapat tetap disimpan apabila diwajibkan oleh hukum, pencegahan penipuan, atau transaksi toko aplikasi.',
      },
      {
        title: '12. Menghapus akun',
        body: 'Orang tua dapat mengajukan permintaan penghapusan di Pengaturan, dari kidgate.app, atau lewat email ke support@kidgate.app dari alamat yang terdaftar pada akun. Permintaan itu ditahan selama 14 hari dan dapat dibatalkan selama masa tersebut; setelah itu akun keluarga, setiap anak dan perangkat di dalamnya, serta berkas tersimpan miliknya dihapus, dan data masuknya sendiri ikut dihilangkan. Penghapusan bersifat permanen dan tidak ada ekspor data setelahnya.',
      },
      {
        title: '13. Hak dan pilihan',
        body: 'Bergantung pada hukum yang berlaku, pengguna dapat mengajukan permintaan akses, koreksi, penghapusan, pembatasan, keberatan, atau penarikan persetujuan. Permintaan semacam itu, termasuk permintaan salinan data yang disimpan tentang sebuah keluarga, dikirim ke support@kidgate.app; saat ini belum ada ekspor mandiri. Pemantauan pesan dan konfirmasi AI dapat dimatikan kapan saja tanpa memengaruhi bagian layanan lainnya. Izin lokasi, notifikasi, kamera, dan perangkat dapat dinonaktifkan melalui sistem operasi, namun fitur yang bergantung padanya akan berhenti atau menjadi tidak lengkap, dan KidGate melaporkan hal itu di layar orang tua alih-alih menampilkan kontrol yang sudah tidak berfungsi.',
      },
      {
        title: '14. Data anak',
      ...
      },
      {
        ...
        body: 'Kebijakan ini dapat berubah seiring perkembangan fitur atau perubahan hukum. Pembaruan yang material akan disampaikan melalui aplikasi atau saluran distribusi yang sesuai. Permintaan dan pertanyaan terkait privasi dikirim ke support@kidgate.app, alamat yang juga dipublikasikan pada halaman KidGate di toko aplikasi.',
      },
    ],
  },
  termsOfService: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Uji coba gratis dengan akses penuh dimulai saat perangkat orang tua dan perangkat anak pertama Anda tersambung, dan berjalan selama periode yang disebutkan di aplikasi. Setelah berakhir, aturan yang Anda atur tetap berjalan tanpa pembayaran di satu perangkat anak — Batas harian, Jam Diblokir, Aplikasi yang Diblokir, batas per aplikasi, Filter web, SafeSearch, Kunci perangkat, permintaan waktu tambahan, tugas hadiah, dan pemantauan pesan — dan orang tua tetap dapat menanyakan posisi terkini perangkat itu dalam jumlah terbatas per hari. SOS tidak pernah berada di balik pembayaran. Aktivitas langsung, riwayat, laporan mingguan, jejak lokasi, alamat, dan Peringatan Tempat menjadi bagian dari Premium. Jika sebuah keluarga memiliki perangkat anak lebih banyak daripada yang dicakup paketnya, perangkat selebihnya dijeda: perangkat itu tetap menerapkan aturan yang sudah diatur, aturan itu dapat dilonggarkan tetapi tidak dapat diperketat, dan perangkat itu berhenti mengirim aktivitas. Anda yang memilih perangkat mana yang tetap dipantau, dan pilihan itu dapat diubah sekali setiap tujuh hari. Menghapus perangkat anak tidak memulai ulang uji coba. Satu keluarga hanya dapat menyambungkan sejumlah terbatas perangkat anak sepanjang usia akun; jumlahnya bergantung pada paket, aplikasi menyebutkannya saat batas itu tercapai, dan perangkat yang sudah dihapus tetap dihitung.',
      },
      {
        title: '8. Langganan dan pembayaran',
        body: 'Pembelian, perpanjangan, pembatalan, dan pengembalian dana ditangani sesuai ketentuan Apple App Store atau Google Play, dan langganan hanya dapat dibeli atau dipulihkan dari aplikasi KidGate untuk iPhone, iPad, atau Android — keluarga yang seluruh perangkatnya berupa komputer, televisi, atau Chromebook memerlukan salah satunya untuk membayar. Satu langganan mencakup seluruh keluarga dan hanya pemilik keluarga yang dapat membeli atau memulihkannya; pembelian yang dicoba dari akun orang tua lain ditolak. Paket bulanan dan tahunan diperpanjang otomatis kecuali dibatalkan melalui toko minimal 24 jam sebelum periode berakhir. Pembelian sekali bayar tidak diperpanjang, mencakup jumlah perangkat anak yang disebutkan di aplikasi, dan berlaku selama KidGate tersedia; bagian 12 menjelaskan apa yang terjadi jika hal itu berakhir. Harga dan fitur paket dapat berubah setelah pemberitahuan yang diwajibkan oleh hukum dan aturan toko aplikasi.',
      },
      {
      ...
      },
      {
        ...
        body: 'Ketentuan ini dapat diperbarui. Perubahan material akan disampaikan secara sepatutnya; penggunaan berkelanjutan setelah tanggal berlaku dianggap sebagai penerimaan atas ketentuan yang diperbarui sejauh diizinkan oleh hukum. Pertanyaan dikirim ke support@kidgate.app.',
      },
    ],
  },
} as const;
