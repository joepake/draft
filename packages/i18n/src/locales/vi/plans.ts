export const plans = {
  ...
  featureWebHistory: 'Lịch sử web',
  featureWeeklyReport: 'Báo cáo tuần',
  featureChildReport: 'Báo cáo từng trẻ',
  featureStarChart: 'Bảng tích sao',
  featureFootnoteAppLimits:
    'Giới hạn ứng dụng cần thiết bị Android hoặc máy Mac — Screen Time của Apple không cho biết trẻ đang mở ứng dụng nào trên iPhone hay iPad.',
