export const child = {
  ...
  readyBody:
    'Nếu cần thêm thời gian sử dụng, con có thể gửi yêu cầu cho bố mẹ ở bên dưới. Khi có việc khẩn cấp, hãy dùng nút SOS.',
  setupCollapsedTitle: 'Hoàn tất thiết lập cùng bố mẹ',
  setupCollapsedCount: 'Còn {{count}} mục cần hoàn tất',
  oneMoment: 'Vui lòng chờ trong giây lát…',
  paused: 'Đã khóa',
  ...
  blockedHoursLockHint:
    'Con hãy nhờ bố mẹ nếu cần thêm thời gian. Khi có việc khẩn cấp, con vẫn gửi được SOS.',
  ...
  errorScreenTimeRequired: 'Cần cấp quyền Thời gian sử dụng.',
