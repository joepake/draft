export const legal = {
  privacyPolicy: {
    ...
    effectiveDate: 'Có hiệu lực từ ngày 15/08/2026',
    intro:
      'KidGate là tên sản phẩm và tên hoạt động của nhà phát triển độc lập vận hành ứng dụng. Chính sách này giải thích cách KidGate xử lý dữ liệu khi phụ huynh dùng dịch vụ để quản lý thiết bị trẻ em.',
    sections: [
      {
      ...
      },
      {
        ...
        body: 'Tùy theo tính năng được bật và quyền được cấp, dữ liệu có thể gồm: định danh tài khoản và dữ liệu đăng nhập Google hoặc Apple; định danh và tên thiết bị; trạng thái kết nối; thiết lập giới hạn; hoạt động ứng dụng và thời gian sử dụng; các trang web mà thiết bị của con yêu cầu truy cập và những trang đã bị lọc; vị trí và lịch sử vị trí; cảnh báo SOS, ra vào khu vực, can thiệp và bảo vệ; ảnh chụp trên thiết bị của con khi gửi SOS hoặc Báo an toàn; tên mà phụ huynh đặt cho từng con, thiết bị được gán cho con và tổng số sao trong tuần hiển thị trên Bảng tích sao; nhiệm vụ thưởng, yêu cầu thêm giờ và báo cáo tuần tổng hợp từ những dữ liệu trên; chẩn đoán kỹ thuật, sự cố, phiên bản ứng dụng và dữ liệu giao dịch đăng ký do cửa hàng ứng dụng cung cấp. KidGate không yêu cầu tên thật của trẻ khi một tính năng không cần đến.',
      },
      {
      ...
      {
        title: '4. Căn cứ và sự đồng ý',
        body: 'KidGate xử lý dữ liệu để cung cấp dịch vụ theo yêu cầu, thực hiện nghĩa vụ pháp lý, bảo vệ lợi ích hợp pháp về an toàn và bảo mật, hoặc dựa trên sự đồng ý khi pháp luật yêu cầu. Phụ huynh chịu trách nhiệm cung cấp mọi thông báo và lấy sự đồng ý cần thiết cho trẻ em hoặc người dùng thiết bị.',
      },
      {
        title: '5. Bên cung cấp dịch vụ',
        body: 'Dữ liệu chỉ được chia sẻ ở mức cần thiết với nhà cung cấp hạ tầng, xác thực, lưu trữ đám mây, thông báo, phân tích sự cố, thanh toán hoặc cửa hàng ứng dụng; với cơ quan có thẩm quyền khi pháp luật yêu cầu; hoặc để ngăn chặn nguy cơ an toàn, gian lận hay lạm dụng. Các bên này có chính sách và nghĩa vụ riêng. KidGate không cho phép họ dùng dữ liệu trẻ em cho mục đích tiếp thị độc lập.',
      },
      {
      ...
      },
      {
        ...
        body: 'Dữ liệu được giữ trong thời gian cần để cung cấp dịch vụ, duy trì bảo mật, giải quyết tranh chấp và đáp ứng nghĩa vụ pháp lý. Phụ huynh có thể yêu cầu xóa tài khoản trong phần Cài đặt. Một số bản ghi tối thiểu có thể tiếp tục được giữ khi pháp luật, phòng chống gian lận, sao lưu luân phiên hoặc giao dịch cửa hàng ứng dụng yêu cầu.',
      },
      {
        title: '8. Quyền và lựa chọn',
        body: 'Tùy pháp luật áp dụng, người dùng có thể yêu cầu truy cập, sửa, xóa, hạn chế hoặc phản đối xử lý và rút lại sự đồng ý. Có thể tắt quyền vị trí, thông báo hoặc quyền thiết bị trong hệ điều hành, nhưng tính năng liên quan sẽ ngừng hoặc hoạt động không đầy đủ.',
      },
      {
        title: '9. Dữ liệu trẻ em',
  ...
  termsOfService: {
    ...
    sections: [
      ...
      {
        title: '2. Mục đích dịch vụ',
        body: 'KidGate cung cấp công cụ hỗ trợ phụ huynh quản lý thiết bị, giới hạn sử dụng, xem trạng thái và nhận cảnh báo. KidGate không thay thế việc giám sát trực tiếp, tư vấn y tế, dịch vụ khẩn cấp, cơ quan thực thi pháp luật hoặc biện pháp bảo vệ trẻ em chuyên nghiệp.',
      },
      {
        title: '3. Trách nhiệm của phụ huynh',
        body: 'Bạn chịu trách nhiệm thông báo phù hợp cho trẻ, lấy sự đồng ý cần thiết, cấu hình quyền chính xác, kiểm tra hoạt động của tính năng và tuân thủ luật về quyền riêng tư, theo dõi, lao động, giáo dục và trẻ em. Không dùng KidGate để theo dõi bí mật, quấy rối, kiểm soát trái phép hoặc xâm phạm quyền của người khác.',
      },
      {
        title: '4. Tài khoản và bảo mật',
        body: 'Bạn chịu trách nhiệm về hoạt động trong tài khoản, độ an toàn của thiết bị, mã PIN và phương thức đăng nhập. Phải báo sớm khi nghi ngờ truy cập trái phép. KidGate có thể tạm khóa tài khoản hoặc thiết bị để bảo vệ người dùng hay điều tra lạm dụng.',
      },
      {
        title: '5. Quyền hệ điều hành và giới hạn kỹ thuật',
        body: 'Một số tính năng phụ thuộc vào quyền hệ điều hành, kết nối mạng, pin, cài đặt nhà sản xuất, dịch vụ vị trí và nền tảng bên thứ ba. Cảnh báo có thể chậm, thiếu hoặc không chính xác. Bạn phải kiểm tra thiết bị và không được dựa duy nhất vào KidGate trong tình huống an toàn hoặc khẩn cấp.',
      },
      {
        title: '6. Thuê bao và thanh toán',
        body: 'Giao dịch, gia hạn, hủy và hoàn tiền được xử lý theo điều khoản của Apple App Store, Google Play hoặc nhà cung cấp thanh toán liên quan. Giá và tính năng gói có thể thay đổi sau thông báo theo yêu cầu pháp luật và quy định cửa hàng.',
      },
      {
      ...
      {
        title: '9. Tính sẵn có và thay đổi',
      ...
      {
        title: '13. Chấm dứt và tranh chấp',
        body: 'Bạn có thể ngừng sử dụng và yêu cầu xóa tài khoản. KidGate có thể đình chỉ hoặc chấm dứt dịch vụ vì vi phạm, rủi ro an toàn hoặc yêu cầu pháp lý. Các bên nên cố gắng giải quyết tranh chấp thiện chí trước; luật và tòa án có thẩm quyền được xác định theo quy định bắt buộc áp dụng cho người dùng và đơn vị vận hành.',
      },
      {
      ...
      {
        title: '15. Phần mềm của bên thứ ba',
