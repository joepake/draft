export const report = {
  ...
  currentWeekTitle: 'Đang ghi nhận',
  currentWeekBody: 'Báo cáo của tuần này sẽ có vào {{day}}.',
  currentWeekNote:
    'Số liệu tính từ thứ Hai đến Chủ nhật, gộp mọi thiết bị trong gia đình. Không thiếu gì đâu — tuần vẫn chưa kết thúc.',
  ...
  rateLimited: 'Bạn đã thử quá nhiều lần. Hãy đợi một phút rồi thử lại.',
  ...
  hubByChild: 'Theo con',
  hubChildUnassigned: 'Chưa gán thiết bị',
  ...
  guestDescription:
    'Đăng nhập để so hôm nay với một ngày bình thường, đối chiếu các con cạnh nhau và nhận báo cáo mỗi thứ Hai.',
  ...
  guestBenefitWeeklyTitle: 'Báo cáo mỗi thứ Hai',
