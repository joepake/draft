export const plans = {
  ...
  featureWebHistory: 'Web History',
  featureWeeklyReport: 'Weekly Report',
  featureChildReport: 'Per-Child Reports',
  featureStarChart: 'Star Chart',
  featureFootnoteAppLimits:
    'App Limits need an Android device or a Mac — Apple’s Screen Time will not report which app is open on an iPhone or iPad.',
