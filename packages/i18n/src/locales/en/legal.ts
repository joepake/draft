export const legal = {
  privacyPolicy: {
    ...
    effectiveDate: 'Effective August 15, 2026',
    intro:
      'KidGate is the product and trading name used by the independent developer who operates the app. This policy explains how KidGate handles data when parents use the service to manage a child’s device.',
    sections: [
      {
      ...
      },
      {
        ...
        body: 'Depending on enabled features and permissions, data may include account identifiers and Google or Apple sign-in data; device identifiers and names; pairing status; limit settings; app activity and screen time; websites a child device requested and which of them were filtered; location and location history; SOS, geofence, tamper, and protection alerts; photos taken on the child device when an SOS or a safety check-in is sent; the names a parent gives each child, the devices assigned to them, and the weekly star totals shown on the star chart; reward tasks, extra-time requests, and the weekly reports that summarise the above; technical diagnostics, crashes, app version, and subscription transaction data supplied by an app store. KidGate does not require a child’s real name when a feature does not need it.',
      },
      {
        title: '3. How data is used',
        body: 'Data supports authentication, device pairing, parental controls, settings sync, alerts, reports, subscriptions, fraud prevention, account security, troubleshooting, and reliability. KidGate does not sell personal data or use child data for behavioral advertising.',
      },
      {
        title: '4. Legal grounds and consent',
        body: 'KidGate processes data to provide requested services, meet legal duties, protect legitimate safety and security interests, or based on consent where required. Parents are responsible for giving required notices and obtaining valid consent for a child or device user.',
      },
      {
        title: '5. Service providers and disclosure',
        body: 'Data is disclosed only as needed to infrastructure, authentication, cloud storage, notification, crash analytics, payment, or app-store providers; to authorities when legally required; or to address safety, fraud, or abuse. Providers have their own duties and policies. They are not authorized by KidGate to use child data for independent marketing.',
      },
      {
      ...
      },
      {
        ...
        body: 'Data is retained as needed to provide the service, maintain security, resolve disputes, and meet legal duties. Parents can request account deletion in Settings. Limited records may remain where required for law, fraud prevention, rotating backups, or app-store transactions.',
      },
      {
        title: '8. Rights and choices',
        body: 'Depending on applicable law, users may request access, correction, deletion, restriction, objection, or withdrawal of consent. Location, notification, and device permissions can be disabled in the operating system, but related features may stop or become incomplete.',
      },
      {
  ...
  termsOfService: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'KidGate provides tools that help parents manage devices, set limits, view status, and receive alerts. It does not replace direct supervision, medical advice, emergency services, law enforcement, or professional child-safety services.',
      },
      {
        title: '3. Parent responsibilities',
        body: 'You must give appropriate notice to children, obtain required consent, configure permissions correctly, test features, and comply with privacy, monitoring, employment, education, and child-protection laws. Do not use KidGate for covert monitoring, harassment, unlawful control, or infringement of another person’s rights.',
      },
      {
        title: '4. Account security',
        body: 'You are responsible for account activity and for protecting devices, PINs, and sign-in methods. Promptly report suspected unauthorized access. KidGate may temporarily restrict accounts or devices to protect users or investigate abuse.',
      },
      {
        title: '5. Platform permissions and technical limits',
        body: 'Features depend on operating-system permissions, network access, battery state, manufacturer settings, location services, and third-party platforms. Alerts may be delayed, incomplete, or inaccurate. You must check devices directly and must not rely solely on KidGate for safety or emergencies.',
      },
      {
        title: '6. Subscriptions and payments',
        body: 'Purchases, renewals, cancellations, and refunds are handled under the terms of Apple App Store, Google Play, or the relevant payment provider. Plan prices and features may change after notice required by law and store rules.',
      },
      {
        title: '7. License and ownership',
