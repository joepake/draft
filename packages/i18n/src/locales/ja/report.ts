export const report = {
  ...
  currentWeekBody: '今週のレポートは{{day}}に届きます。',
  currentWeekNote:
    '月曜日から日曜日まで、家族のすべてのデバイスが対象です。まだ足りないものはありません。週が終わっていないだけです。',

  emptyTitle: 'まだレポートがありません',
  emptyBody:
    'レポートは毎週月曜の朝に届きます。今週の分をここで作成することもできます（直近 7 日間が対象です）。',
  noUsage:
  ...
  hubByChild: 'お子さまごと',
  hubChildUnassigned: '割り当てられたデバイスがありません',
  hubByDevice: 'デバイスごと',
  ...
  guestDescription:
    'ログインすると、今日を普段の日と比べ、子どもたちを並べて確認し、毎週月曜日にレポートを受け取れます。',
  ...
  guestBenefitWeeklyTitle: '毎週月曜日のレポート',
