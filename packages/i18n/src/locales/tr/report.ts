export const report = {
  ...
  weekOf: '{{week}}. hafta',
  range: '{{from}} – {{to}}',
  triggerScheduled: 'Pazartesi günü gönderildi',
  ...
  findingQuietWeek:
    'Sakin bir hafta — toplam {{total}} ve ilginizi gerektiren hiçbir şey olmadı.',
  ...
  currentWeekBody: 'Bu haftanın raporu {{day}} günü geliyor.',
  currentWeekNote:
    'Pazartesiden pazara kadar, ailedeki tüm cihazları kapsar. Henüz eksik bir şey yok — hafta bitmedi.',

  emptyTitle: 'Henüz rapor yok',
  emptyBody:
    'Rapor her pazartesi sabahı gelir. Bu haftanınkini şimdi de yazabilirsiniz — son yedi günü kapsar.',
  noUsage:
  ...
  hubChildUnassigned: 'Atanmış cihaz yok',
  ...
  guestDescription:
    'Bugünü normal bir günle ölçmek, çocuklarınızı yan yana karşılaştırmak ve her pazartesi bir rapor almak için giriş yapın.',
  ...
  guestBenefitWeeklyTitle: 'Her pazartesi bir rapor',
