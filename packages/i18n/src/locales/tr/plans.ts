export const plans = {
  ...
  planTrialMeta: 'Ücretsiz · {{days}} gün · Tam erişim',
  ...
  sectionIncludedFeaturesSubtitle:
    'Aşağıdakilerin tümü hem Deneme hem de Premium’da yer alır.',
  footerLegal:
  ...
  featureAppAlerts: 'Uygulama uyarıları',
  featureUsageReports: 'Kullanım Raporları',
  featureActivityFeed: 'Etkinlik Akışı',
  featureParentPinProtection: 'Ebeveyn PIN’i Koruması',
  ...
  subscribeToContinue:
    'Şu anda ücretsiz plandasınız. Her şeyi yeniden açmak için abone olun.',
