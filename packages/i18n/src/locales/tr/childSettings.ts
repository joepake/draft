export const childSettings = {
  pageTitle: 'Ayarlar',
  statusUnlocked: 'Ebeveyn erişimi açık',
  ...
  uninstallProtectionSectionTitle: 'Kaldırma koruması',
  uninstallProtectionSectionDescription:
    'Bu telefonun KidGate’i kaldırmasını engeller. Android bir kez izin ister.',
  uninstallProtectionLabel: 'Kaldırmayı engelle',
  uninstallProtectionHintOn: 'Açık. Kapatırsan ebeveynine bildirilir.',
