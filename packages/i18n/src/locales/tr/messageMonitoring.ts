export const messageMonitoring = {
  ...
  guidance: {
    ...
    selfHarm:
      'Bu tür kelimeler bir plandan çok bir sinyaldir ve doğrudan sormak bu fikri aşılamaz. Ne gördüğünüzü ve kızgın olmadığınızı söyleyin; yanıt sizi korkutursa aynı gün bir kriz hattını arayın.',
    explicit:
      'Bu ona gönderilmiş, ona gösterilmiş ya da onun yazdığı bir şey olabilir. Tepki vermeden önce hangisi olduğunu öğrenin: müstehcen içerik almak, göndermekten farklı bir konuşmadır.',
    violence:
      'Bir tehdit, arkadaşlar arası şaka gibi görünse de ciddiye alınmayı hak eder. Okuldan biri mi sorun; öyleyse okul, bunu durdurmanın en hızlı yoludur.',
    bullying:
      'Çocuklar bunu kendiliğinden pek anlatmaz ve aynı kelimeler, çocuğunuz hedef olduğunda da işin içinde olduğunda da görünür. Kimin suçlu olduğunu değil ne olduğunu sorun ve okul isteyebilir diye tarihleri not edin.',
    drugs:
      'İşaretlenen bir kelime kullanım kanıtı değildir — merak, şarkılar ve şakalar da bunu tetikler. Odasını aramak yerine açıkça sorun; en önemlisi size anlatmayı sürdürmesidir.',
    alcohol:
      'Gençlerin sıradan konuşmalarında yaygındır, bu yüzden bunu kanıt değil bağlam olarak okuyun. Bir parti konuyu aciliyete çevirmeden önce kuralınızı açıkça söylemek için iyi bir an.',
    tobacco:
      'Elektronik sigara arkadaş grubu üzerinden yayılır ve genelde gizli değil sosyaldir. Arkadaşlarının ne kullandığını sorun: somut şeyin adını koymak genel bir uyarıdan daha etkilidir.',
    gambling:
      'Ganimet kutuları, kart paketleri ve eşya bahisleri de buna girer ve bir çocuğa nadiren kumar gibi gelir. Bunu para sorunu saymadan önce oyun içinde neye harcadığına bakın.',
    profanity:
  ...
  parentProfanityLabel: 'Küfürlü ifadeleri de işaretle',
  parentProfanityHint:
  ...
  alertBodySearch: 'Şurada yapılan arama:',
  aiLegend:
