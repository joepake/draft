export const legal = {
  privacyPolicy: {
    ...
    effectiveDate: 'In vigore dal 15 agosto 2026',
    intro:
      'KidGate è il nome commerciale utilizzato dallo sviluppatore indipendente che gestisce l’app. La presente informativa spiega come KidGate tratta i dati quando i genitori utilizzano il servizio per gestire il dispositivo di un minore.',
    sections: [
      {
      ...
      {
        title: '2. Dati che potremmo trattare',
        body: 'A seconda delle funzioni attive e dei permessi concessi, i dati possono includere identificativi dell’account e dati di accesso Google o Apple; identificativi e nomi dei dispositivi; stato di abbinamento; impostazioni dei limiti; attività delle app e tempo di utilizzo; i siti richiesti dal dispositivo del bambino e quali di essi sono stati filtrati; posizione e cronologia della posizione; avvisi SOS, di zona, di manomissione e di protezione; foto scattate sul dispositivo del bambino quando viene inviato un SOS o un check-in di sicurezza; i nomi che un genitore dà a ciascun figlio, i dispositivi loro assegnati e i totali settimanali di stelle mostrati nella tabella delle stelle; compiti con ricompensa, richieste di tempo extra e i report settimanali che riassumono quanto sopra; diagnostica tecnica, arresti anomali, versione dell’app e dati sulle transazioni di abbonamento forniti da uno store. KidGate non richiede il nome reale di un bambino quando una funzione non ne ha bisogno.',
      },
      {
        title: '3. Come vengono utilizzati i dati',
        body: 'I dati supportano l’autenticazione, l’abbinamento dei dispositivi, i controlli parentali, la sincronizzazione delle impostazioni, gli avvisi, i report, gli abbonamenti, la prevenzione delle frodi, la sicurezza dell’account, la risoluzione dei problemi e l’affidabilità. KidGate non vende dati personali né utilizza i dati dei minori per la pubblicità comportamentale.',
      },
      {
        title: '4. Basi giuridiche e consenso',
        body: 'KidGate tratta i dati per fornire i servizi richiesti, adempiere a obblighi di legge, tutelare legittimi interessi di sicurezza, oppure sulla base del consenso, ove richiesto. I genitori sono responsabili di fornire le informative necessarie e di ottenere un consenso valido per il minore o per l’utente del dispositivo.',
      },
      {
        title: '5. Fornitori di servizi e comunicazione a terzi',
        body: 'I dati vengono comunicati solo nella misura necessaria a fornitori di infrastrutture, autenticazione, archiviazione cloud, notifiche, analisi degli arresti anomali, pagamenti o store di app; alle autorità quando richiesto per legge; oppure per far fronte a problemi di sicurezza, frode o abuso. I fornitori hanno propri obblighi e proprie informative. Non sono autorizzati da KidGate a utilizzare i dati dei minori per finalità di marketing autonome.',
      },
      {
      ...
      },
      {
        ...
        body: 'I dati sono conservati per il tempo necessario a fornire il servizio, garantire la sicurezza, risolvere controversie e adempiere a obblighi di legge. I genitori possono richiedere la cancellazione dell’account nelle Impostazioni. Alcuni dati limitati potrebbero essere conservati laddove richiesto dalla legge, per la prevenzione delle frodi, per i backup a rotazione o per le transazioni effettuate tramite lo store di app.',
      },
      {
        title: '8. Diritti e scelte',
        body: 'In base alla legge applicabile, gli utenti possono richiedere l’accesso, la rettifica, la cancellazione, la limitazione, l’opposizione al trattamento o la revoca del consenso. Le autorizzazioni relative a posizione, notifiche e dispositivo possono essere disattivate dal sistema operativo, ma le funzionalità correlate potrebbero interrompersi o risultare incomplete.',
      },
      {
        title: '9. Dati dei minori',
      ...
      {
        title: '10. Incidenti relativi ai dati',
  ...
  termsOfService: {
    ...
    sections: [
      ...
      {
        title: '2. Finalità del servizio',
        body: 'KidGate fornisce strumenti che aiutano i genitori a gestire i dispositivi, impostare limiti, visualizzare lo stato e ricevere avvisi. Non sostituisce la supervisione diretta, il parere medico, i servizi di emergenza, le forze dell’ordine o i servizi professionali per la tutela dei minori.',
      },
      {
        title: '3. Responsabilità del genitore',
        body: 'Devi fornire un’adeguata informativa ai minori, ottenere il consenso richiesto, configurare correttamente le autorizzazioni, testare le funzionalità e rispettare le leggi in materia di privacy, monitoraggio, lavoro, istruzione e tutela dei minori. Non utilizzare KidGate per monitoraggio occulto, molestie, controllo illecito o violazione dei diritti di terzi.',
      },
      {
        title: '4. Sicurezza dell’account',
        body: 'Sei responsabile dell’attività dell’account e della protezione di dispositivi, PIN e metodi di accesso. Segnala tempestivamente eventuali accessi non autorizzati sospetti. KidGate può limitare temporaneamente account o dispositivi per proteggere gli utenti o indagare su casi di abuso.',
      },
      {
        title: '5. Autorizzazioni della piattaforma e limiti tecnici',
        body: 'Le funzionalità dipendono dalle autorizzazioni del sistema operativo, dalla connessione di rete, dallo stato della batteria, dalle impostazioni del produttore, dai servizi di localizzazione e da piattaforme di terze parti. Gli avvisi potrebbero essere ritardati, incompleti o inesatti. Devi verificare i dispositivi direttamente e non devi fare affidamento esclusivamente su KidGate per la sicurezza o per le emergenze.',
      },
      {
        title: '6. Abbonamenti e pagamenti',
        body: 'Acquisti, rinnovi, cancellazioni e rimborsi sono gestiti secondo i termini di Apple App Store, Google Play o del relativo fornitore di servizi di pagamento. I prezzi e le caratteristiche dei piani possono cambiare previo avviso richiesto dalla legge e dalle regole degli store.',
      },
      {
        title: '7. Licenza e proprietà',
      ...
      {
        title: '9. Disponibilità e modifiche',
      ...
      {
        title: '10. Esclusioni di garanzia',
      ...
      {
        title: '15. Software di terze parti',
