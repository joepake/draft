  ...
  privacyPolicy: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Tre funzioni utilizzano i modelli Gemini di Google, raggiunti tramite Google Cloud: il riepilogo testuale del report settimanale, generato a partire dai dati di utilizzo della famiglia stessa; la classificazione delle app e dei domini dei siti nelle categorie usate dal Filtro web e dagli elenchi di app, conservata in una tabella condivisa che registra un dominio e la sua categoria, non quale famiglia lo abbia visitato; e il passaggio di conferma descritto nella sezione 3, che viene eseguito solo quando il genitore vi ha acconsentito. Questi modelli producono valutazioni che possono essere errate. Una categoria, una frase di riepilogo o un avviso su un messaggio sono un invito a verificare, non un accertamento di fatto, e su tale base KidGate non adotta alcuna decisione che produca effetti giuridici o similmente significativi su un minore. I risultati dei modelli non vengono utilizzati per addestrare i modelli di Google.',
      },
      {
        title: '6. Basi giuridiche e consenso',
        body: 'KidGate tratta i dati per fornire i servizi richiesti, adempiere a obblighi di legge, tutelare legittimi interessi di sicurezza, oppure sulla base del consenso, ove richiesto. I genitori sono responsabili di fornire le informative necessarie e di ottenere un consenso valido per il minore o per l’utente del dispositivo. Il monitoraggio dei messaggi e la conferma con IA sono due attivazioni separate ed esplicite e possono essere revocate in qualsiasi momento: il monitoraggio dei messaggi si attiva per singolo dispositivo, mentre la conferma con IA viene accettata una sola volta per la famiglia e registrata con chi l’ha accettata e quando.',
      },
      {
        title: '7. Fornitori di servizi',
        body: 'KidGate è costruito su Google Cloud e Firebase, che forniscono l’autenticazione, il database, l’archiviazione dei file, le funzioni server, le notifiche push tramite Firebase Cloud Messaging, i report sugli arresti anomali tramite Firebase Crashlytics e i modelli Gemini indicati nella sezione 5. Anche Apple e Google trattano acquisti, rinnovi e rimborsi degli abbonamenti tramite i rispettivi store di app, e Google Analytics tratta le misurazioni descritte nella sezione 8. Altri quattro fornitori vedono ciascuno una sola cosa: HERE Technologies trasforma una posizione segnalata in un indirizzo e disegna le tessere della mappa dietro le schermate della posizione, quindi riceve le coordinate segnalate da un dispositivo; Resend recapita le email che KidGate invia — un avviso SOS a un contatto fidato e il report settimanale; Cloudflare distribuisce i programmi di installazione per computer; e la rete di distribuzione unpkg fornisce la libreria delle mappe alle app genitore. I dati vengono comunicati a questi fornitori solo nella misura necessaria a far funzionare il servizio; alle autorità quando richiesto per legge; oppure per far fronte a problemi di sicurezza, frode o abuso. I fornitori hanno propri obblighi e proprie informative e nessuno di essi è autorizzato da KidGate a utilizzare i dati dei minori per finalità di marketing autonome.',
      },
      {
        title: '8. Statistiche del sito e cookie',
        body: 'Il sito kidgate.app misura tre cose con Google Analytics: le visite alle pagine e i clic su ciascuno dei due link di download per computer. L’archiviazione analitica è rifiutata per impostazione predefinita, quindi non viene impostato alcun cookie analitico e nulla viene memorizzato nel browser di chi legge; ogni visita viene conteggiata a partire da una richiesta senza cookie, con l’indirizzo IP troncato. Google Signals e gli identificativi pubblicitari sono disattivati e non viene inviato nulla che identifichi chi legge o una famiglia. Le app KidGate inviano alla stessa proprietà un numero ristretto di eventi per indicare quali funzioni vengono usate; tali eventi contengono un identificativo dell’installazione dell’app — mai l’identificativo pubblicitario del dispositivo, che le app non raccolgono — e mai il nome di un bambino, i suoi messaggi, la sua posizione o la sua navigazione. Le app e il sito non utilizzano alcuna rete pubblicitaria o di tracciamento.',
      },
      {
      ...
      },
      {
        ...
        body: 'Quando è necessario per rispondere a una richiesta di assistenza o diagnosticare un guasto, il personale autorizzato di KidGate può aprire un account famiglia e vedere ciò che vede il genitore: la sua configurazione e i suoi dispositivi, e l’attività al suo interno — inclusi la cronologia della posizione, la cronologia web, gli avvisi sui contenuti e le foto allegate a un SOS o a un Check-in. Può inoltre modificare le impostazioni e inviare comandi ai dispositivi. Tale accesso è limitato al personale autorizzato, richiede l’autenticazione a due fattori e viene utilizzato esclusivamente per finalità di assistenza. L’apertura di un account famiglia scrive una riga nel registro delle attività di quella famiglia, visibile ai suoi genitori, con l’ora e la richiesta di assistenza a cui si riferisce; ogni lettura dei dati di una famiglia tramite gli strumenti del gestore viene registrata con l’ora e un motivo dichiarato. Le singole azioni compiute durante una sessione di assistenza oggi non vengono registrate separatamente.',
      },
      {
        title: '11. Per quanto tempo vengono conservati i dati',
        body: 'I dati scadono secondo un calendario e vengono eliminati automaticamente: il Tempo di utilizzo e l’utilizzo per app, la cronologia web, la cronologia dei video, la cronologia della posizione e il registro delle attività dopo 30 giorni; gli avvisi SOS, i Check-in di sicurezza e le richieste di tempo extra dopo 90 giorni; i report settimanali dopo 365 giorni. I codici di abbinamento scadono nel giro di pochi minuti e un accesso dal browser dura 7 giorni se concesso dall’app, oppure 8 ore se sbloccato con il PIN genitore. Alcuni dati oggi non hanno scadenza e vengono conservati fino all’eliminazione dell’account famiglia: l’account e le sue impostazioni, i luoghi salvati, le schede dei figli e dei dispositivi, i compiti premio, le richieste di siti, le tabelle delle stelle e le classifiche del tempo di utilizzo, e l’elenco delle app. Le richieste di assistenza, le risposte e le eventuali schermate allegate vengono eliminate 90 giorni dopo la risoluzione della richiesta. Una traccia del fatto che l’eliminazione di un account è stata richiesta e completata — un hash dell’indirizzo email e le date, nient’altro — viene conservata per 12 mesi dal completamento, in modo da poter rispondere a una contestazione sull’eliminazione. Alcuni dati limitati potrebbero inoltre essere conservati laddove richiesto dalla legge, per la prevenzione delle frodi o per le transazioni effettuate tramite lo store di app.',
      },
      {
        title: '12. Eliminazione dell’account',
        body: 'Il genitore può richiedere l’eliminazione nelle Impostazioni, da kidgate.app oppure via email a support@kidgate.app dall’indirizzo associato all’account. La richiesta resta in sospeso per 14 giorni e in questo periodo può essere annullata; trascorso tale termine, l’account famiglia, ogni figlio e ogni dispositivo che vi appartengono e i file archiviati che vi appartengono vengono eliminati, e l’accesso stesso viene rimosso. L’eliminazione è definitiva e non è previsto alcun export successivo.',
      },
      {
        title: '13. Diritti e scelte',
        body: 'In base alla legge applicabile, gli utenti possono richiedere l’accesso, la rettifica, la cancellazione, la limitazione, l’opposizione al trattamento o la revoca del consenso. Tali richieste, inclusa quella di una copia dei dati conservati su una famiglia, vanno inviate a support@kidgate.app; oggi non è previsto alcun export in autonomia. Il monitoraggio dei messaggi e la conferma con IA possono essere disattivati in qualsiasi momento senza conseguenze per il resto del servizio. Le autorizzazioni relative a posizione, notifiche, fotocamera e dispositivo possono essere disattivate dal sistema operativo, ma le funzionalità che ne dipendono si interromperanno o risulteranno incomplete, e KidGate lo segnala sullo schermo del genitore invece di mostrare un comando che non funziona più.',
      },
      {
      ...
      },
      {
        ...
        body: 'La presente informativa può essere modificata al variare delle funzionalità o della normativa. Gli aggiornamenti sostanziali saranno comunicati nell’app o tramite un canale di distribuzione appropriato. Le richieste e le domande in materia di privacy vanno inviate a support@kidgate.app, l’indirizzo pubblicato anche nelle schede di KidGate sugli store di app.',
      },
    ],
  },
  termsOfService: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Una prova gratuita con accesso completo inizia quando vengono abbinati il primo dispositivo genitore e il primo dispositivo del bambino e dura per il periodo indicato nell’app. Al termine, le regole che hai configurato continuano a funzionare senza pagamento su un dispositivo del bambino — Limite giornaliero, Orari di blocco, App bloccate, limiti per singola app, il Filtro web, la ricerca sicura, il Blocco dispositivo, le richieste di tempo extra, i compiti premio e il monitoraggio dei messaggi — e un genitore può ancora chiedere a quel dispositivo la sua posizione attuale un numero limitato di volte al giorno. SOS non è mai a pagamento. L’attività in tempo reale, la cronologia, i report settimanali, il tracciamento della posizione, gli indirizzi e gli avvisi sui luoghi diventano parte di Premium. Quando una famiglia ha più dispositivi dei figli di quanti ne copra il piano, i dispositivi eccedenti vengono messi in pausa: continuano ad applicare le regole già impostate, tali regole possono essere allentate ma non inasprite, e smettono di inviare attività. Scegli tu quale dispositivo resta monitorato, e questa scelta può essere cambiata una volta ogni sette giorni. La rimozione di un dispositivo del bambino non fa ripartire la prova. Una famiglia può abbinare un numero limitato di dispositivi dei figli nell’arco di vita dell’account; il numero dipende dal piano, l’app lo indica quando viene raggiunto, e un dispositivo rimosso continua a essere conteggiato.',
      },
      {
        title: '8. Abbonamenti e pagamenti',
        body: 'Acquisti, rinnovi, cancellazioni e rimborsi sono gestiti secondo i termini di Apple App Store o Google Play, e un abbonamento può essere acquistato o ripristinato soltanto dall’app KidGate per iPhone, iPad o Android — una famiglia i cui dispositivi sono tutti computer, televisori o Chromebook ha bisogno di uno di questi per pagare. Un solo abbonamento copre tutta la famiglia e soltanto il proprietario della famiglia può acquistarlo o ripristinarlo; un acquisto tentato dall’account di un altro genitore viene rifiutato. I piani mensili e annuali si rinnovano automaticamente salvo disdetta tramite lo store almeno 24 ore prima della fine del periodo. L’acquisto una tantum non si rinnova, copre il numero di dispositivi dei figli indicato nell’app e vale finché KidGate è disponibile; la sezione 12 spiega che cosa accade se ciò dovesse finire. I prezzi e le caratteristiche dei piani possono cambiare previo avviso richiesto dalla legge e dalle regole degli store.',
      },
      {
      ...
      },
      {
        ...
        body: 'I presenti termini possono essere aggiornati. Le modifiche sostanziali saranno comunicate in modo appropriato; il proseguimento dell’utilizzo dopo la data di entrata in vigore comporta l’accettazione dei termini aggiornati ove consentito dalla legge. Le domande vanno inviate a support@kidgate.app.',
      },
    ],
  },
} as const;
