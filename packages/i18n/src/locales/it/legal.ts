  ...
  privacyPolicy: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'I dati scadono secondo un calendario e vengono eliminati automaticamente: il Tempo di utilizzo e l’utilizzo per app, la cronologia web, la cronologia dei video, la cronologia della posizione e il registro delle attività dopo 30 giorni; gli avvisi SOS, i Check-in di sicurezza e le richieste di tempo extra dopo 90 giorni; i report settimanali dopo 365 giorni. I codici di abbinamento scadono nel giro di pochi minuti e un accesso dal browser dura 7 giorni. Alcuni dati oggi non hanno scadenza e vengono conservati fino all’eliminazione dell’account famiglia: l’account e le sue impostazioni, i luoghi salvati, le schede dei figli e dei dispositivi, i compiti premio, le richieste di siti, le tabelle delle stelle e le classifiche del tempo di utilizzo, e l’elenco delle app. Le richieste di assistenza, le risposte e le eventuali schermate allegate vengono eliminate 90 giorni dopo la risoluzione della richiesta. Alcuni dati limitati potrebbero inoltre essere conservati laddove richiesto dalla legge, per la prevenzione delle frodi, per i backup a rotazione o per le transazioni effettuate tramite lo store di app.',
      },
      {
