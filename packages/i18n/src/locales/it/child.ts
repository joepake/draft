export const child = {
  ...
  readyBody:
    'Se ti serve più tempo di utilizzo, puoi inviare una richiesta ai tuoi genitori qui sotto. In un’emergenza usa il pulsante SOS.',
  setupCollapsedTitle: 'Completa la configurazione con un genitore',
  setupCollapsedCount: 'Ne mancano {{count}} da completare',
  oneMoment: 'Un attimo…',
  paused: 'Bloccato',
  ...
  errorScreenTimeRequired: 'È richiesta l’autorizzazione Tempo di utilizzo.',
