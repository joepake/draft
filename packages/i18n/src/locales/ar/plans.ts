export const plans = {
  ...
  featureWebHistory: 'سجل الويب',
  featureWeeklyReport: 'التقرير الأسبوعي',
  featureChildReport: 'تقارير لكل طفل',
  featureStarChart: 'لوحة النجوم',
  featureFootnoteAppLimits:
    'تحتاج حدود التطبيقات إلى جهاز Android أو جهاز Mac — لا تذكر ميزة Screen Time من Apple أي تطبيق مفتوح على iPhone أو iPad.',
