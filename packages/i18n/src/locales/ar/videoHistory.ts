export const videoHistory = {
  ...
  unsupportedNeedsExtension:
    'لا يستطيع KidGate على هذا الكمبيوتر معرفة الفيديوهات التي تُشاهد — فهو يقرأ أسماء المواقع لا محتوى الصفحات. أما إضافة KidGate لمتصفح Chrome فتستطيع: أضفها على هذا الكمبيوتر وستبلغ عن الفيديوهات المشاهَدة كجهاز مستقل.',
  viaExtension: 'عبر الإضافة',
  extensionStepInstall: 'أضف إضافة KidGate إلى Chrome على هذا الكمبيوتر',
  extensionStepPair: 'اقرنها — ستظهر كجهاز مستقل',
  extensionStepEnable: 'فعّل «تسجيل المقاطع المُشاهَدة» لذلك الجهاز',
  ...
  viewsMeta_one: '{{count}} مرة',
  viewsMeta: '{{count}} مرة',
  dayToday: 'اليوم',
  dayYesterday: 'أمس',
  dayCount_one: '{{count}} فيديو',
  dayCount: '{{count}} فيديو',
  heroVideos: 'فيديوهات',
  heroChannels: 'قنوات',
  heroViews: 'مشاهدات',
  emptyStepEnable: 'فعّل التسجيل',
  emptyStepWatch: 'يشاهد طفلك YouTube',
  emptyStepAppear: 'تظهر الفيديوهات هنا',
