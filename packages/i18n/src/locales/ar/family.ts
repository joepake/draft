export const family = {
  settingsReachedDevice: 'وصلت الإعدادات إلى هذا الجهاز {{when}}',
  title: 'العائلة',
  connectButton: 'ربط',
  ...
  parkReviewBody:
    'عند انتهاء فترتك التجريبية يواصل جهاز واحد إرسال التقارير وتلقّي تعديلات القواعد، وتحتفظ بقية الأجهزة بالقواعد الموجودة لديها. على تلك الأجهزة لن يمكنك بعد ذلك سوى تخفيف القاعدة، لذا فما هو مُطفأ الآن سيبقى مُطفأ.',
  rulesEnforcedOn: 'مطبَّقة على {{enforced}} من {{total}} أجهزة',
  rulesPausedBehind: 'متوقف مؤقتًا — لا يزال على إعداد أقدم',
  rulesTightenRefused:
    'الجهاز المتوقف مؤقتًا يمكن تخفيف قواعده فقط، لا تشديدها. قم بالترقية لتغيير ذلك في كل الأجهزة.',
  ...
  chooseMonitoredBody:
    'كل القواعد لا تزال تعمل على جميعها. الجهاز الذي تختاره يرسل وقت الشاشة والموقع، وهو الوحيد الذي لا يزال بإمكانك تشديد قواعده — أما على الأجهزة الأخرى فلا يمكنك سوى تخفيفها. يمكنك تغيير اختيارك مرة كل {{days}} أيام.',
