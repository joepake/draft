export const sos = {
  ...
  trustedContactsAddSection: 'إضافة جهة اتصال',
  trustedContactsAddHint: 'حتى {{max}}. أخبرهم مسبقًا — تصل الرسالة دون تنبيه.',
  trustedContactsNameLabel: 'الاسم',
  trustedContactsEmailLabel: 'البريد الإلكتروني',
  trustedContactsAddButton: 'إضافة جهة اتصال',
  trustedContactsFull: 'القائمة ممتلئة. احذف واحدة لإضافة أخرى.',
  trustedContactsInvalid: 'أدخل اسمًا وعنوان بريد إلكتروني صالحًا.',
  trustedContactsSaveFailed: 'تعذّر الحفظ. حاول مرة أخرى بعد قليل.',
  trustedContactsRemoveAccessibility: 'إزالة {{name}}',
  trustedContactsPrivacyNote:
    'تتلقى كل جهة اتصال اسم الجهاز وآخر موقع معروف عبر البريد الإلكتروني. لا تُرسل أي صورة.',
} as const;
