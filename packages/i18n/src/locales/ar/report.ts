...
export const report = {
  ...
  findingAppSurge:
    'ارتفع استخدام تطبيق {{app}} بمقدار {{delta}} عن الأسبوع الماضي — {{duration}} إجمالًا.',
  ...
  findingBlockedWeb: 'تمت تصفية {{count}} موقعًا، مقابل {{previous}} الأسبوع الماضي.',
  ...
  findingLimitRespected: 'لم يبلغ الاستخدام الحد اليومي {{limit}} طوال {{count}} يوم.',
  ...
  actionTitle: 'شيء واحد يمكنك فعله',
  ...
  currentWeekBody: 'تقرير هذا الأسبوع يصل {{day}}.',
  currentWeekNote:
    'يغطي من الاثنين إلى الأحد، على كل أجهزة العائلة. لا ينقصه شيء بعد — الأسبوع لم ينته.',

  emptyTitle: 'لا يوجد تقرير بعد',
  emptyBody:
    'يصل تقرير كل صباح اثنين. يمكنك أيضًا كتابة تقرير هذا الأسبوع الآن — وهو يغطي آخر سبعة أيام.',
  noUsage:
  ...
  hubChildUnassigned: 'لا يوجد جهاز مُعيَّن',
  ...
  guestDescription:
    'سجّل الدخول لتقيس اليوم مقابل يوم عادي، وتقارن أبناءك جنبًا إلى جنب، وتستلم تقريرًا مكتوبًا كل اثنين.',
  ...
  guestBenefitWeeklyTitle: 'تقرير كل اثنين',
