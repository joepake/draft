...
export const errors = {
  ...
  premiumSubscriptionRequired:
    'هذه الميزة تحتاج إلى Premium. كل القواعد التي ضبطتها — الحدود ووقت النوم وحظر التطبيقات وفلتر الويب والموقع وSOS — تبقى مجانية.',
  ...
  registerParentDeviceFirst:
    'لم يتم إعداد هذا الهاتف كجهاز لأحد الوالدين بعد. افتح KidGate هنا، واختر "هذا جهاز أحد الوالدين" في شاشة البداية، ثم حاول الاقتران مرة أخرى.',
